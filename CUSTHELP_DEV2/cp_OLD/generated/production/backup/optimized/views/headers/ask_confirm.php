...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((4519)) . '', 'template'=>'standard.php', 'clickstream'=>'incident_confirm'));
...
(\RightNow\Utils\Url::getParameter('i_id') == NULL) ):?>
                ...
                <?else:?>
                    <a href="/app/account/questions/detail/i_id/<?=\RightNow\Utils\Url::getParameter('i_id');?>">#<?=\RightNow\Utils\Connect::getFormattedObjectFieldValue(array
