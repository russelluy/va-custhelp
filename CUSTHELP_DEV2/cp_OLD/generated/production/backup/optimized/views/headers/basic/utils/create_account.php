...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4872)) . '', 'template'=>'basic.php', 'login_required'=>'false', 'redirect_if_logged_in'=>'account/overview', 'force_https'=>'true'));
...
<h1><?=\RightNow\Utils\Config::msgGetFrom((1414));?></h1>
...
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Login','required' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4846)) . '',));
?>
    <?if( (\RightNow\Utils\Config::getConfig(193) == true) ):?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.NewPassword','require_validation' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '',));
?>
    <?endif;?>
    <?if(
...
?>
    <?endif;?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicCustomAllInput',
array('table' => 'Contact',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4849)) . '','on_success_url' => '/app/account/overview',));
?>
