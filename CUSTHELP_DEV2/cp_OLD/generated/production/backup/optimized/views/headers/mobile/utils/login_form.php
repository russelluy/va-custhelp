...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4833)) . '', 'template'=>'mobile.php', 'login_required'=>'false'));
...
.rn_LoginForm.rn_ContentLoading{background:url(<?=FileSystem::getOptimizedAssetsDir();?>themes/mobile/images/loading.gif) no-repeat center center;}
...
( 0 => 'standard/login/LoginForm', ), '/mobile/utils/login_form.js', '1439568043');?>"></script>
