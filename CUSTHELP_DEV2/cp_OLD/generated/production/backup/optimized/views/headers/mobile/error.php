...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((7587)) . '', 'template'=>'mobile.php', 'login_required'=>'false'));
...
case 1: $errorTitle = getMessage((32695));
$errorMessage = getMessage((4606));
break;
case 2: $errorTitle = getMessage((32695));
$errorMessage = getMessage((3696));
break;
case 3: $errorTitle = getMessage((1925));
$errorMessage = getMessage((3706));
break;
case 4: $errorTitle = getMessage((4661));
$errorMessage = getMessage((4674));
break;
case 5: $errorTitle = getMessage((14003));
$errorMessage = getMessage((2891));
break;
case 6: $errorTitle = getMessage((4661));
$errorMessage = getMessage((4548));
break;
case 7: $externalLogin = getConfig((377));
$loginPage = ($externalLogin) ? $externalLogin : '/app/' . getConfig((229)) . sessionParm();
$errorTitle = getMessage((1372));
$errorMessage = getMessage((4428)) . "<br/><a href='$loginPage'>" . getMessage((1075)) . '</a>';
break;
case 'sso9': $errorTitle = getMessage((2176));
$errorMessage = sprintf(getMessage((3784)), '<a href="/app/account/profile' . sessionParm() . '">', '</a>');
break;
case 'sso10': $errorTitle = getMessage((2176));
$errorMessage = sprintf(getMessage((3701)), '<a href="/app/account/profile' . sessionParm() . '">', '</a>');
break;
case 'sso11': $errorTitle = getMessage((1697));
$errorMessage = sprintf(getMessage((3704)), '<a href="/app/utils/account_assistance' . sessionParm() . '">', '</a>');
break;
case 'sso13': case 'sso14': case 'sso15': $errorTitle = getMessage((1047));
$errorMessage = getMessage((2565));
break;
case 404: $errorTitle = getMessage((2825));
$errorMessage = sprintf(getMessage((2920)), urldecode(getUrlParm('url')));
break;
default: $errorTitle = getMessage((32916));
$errorMessage = getMessage((28382));
break;
}
?>
