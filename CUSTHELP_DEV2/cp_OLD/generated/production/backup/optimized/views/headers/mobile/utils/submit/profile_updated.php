...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4983)) . '', 'template'=>'mobile.php', 'login_required'=>'true'));
...
?>
        ...
        <section role="main">
<div id="rn_PageTitle">
    <h1><?=\RightNow\Utils\Config::msgGetFrom((32426));?></h1>
</div>
<div id="rn_PageContent">
    <div class="rn_Padding">
        <?=\RightNow\Utils\Config::msgGetFrom((4215));?>
    </div>
</div>
        </section>
