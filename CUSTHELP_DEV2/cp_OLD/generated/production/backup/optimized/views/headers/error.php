...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((7587)) . '', 'template'=>'standard.php', 'login_required'=>'false'));
...
if($externalLogin) $loginPage = $externalLogin;
else $loginPage = '/app/' . getConfig((229)) . sessionParm();
...
break;
case 'sso11': $errorTitle = getMessage((32481));
$errorMessage = sprintf(getMessage((3705)), '<a href="/app/utils/account_assistance' . sessionParm() . '">', '</a>');
break;
case 'sso13': case 'sso14': case 'sso15': case 'sso16': case 'sso17': $errorTitle = getMessage((1047));
