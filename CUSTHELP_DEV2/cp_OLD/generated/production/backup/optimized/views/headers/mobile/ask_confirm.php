...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4519)) . '', 'template'=>'mobile.php', 'clickstream'=>'incident_confirm'));
...
<section id="rn_PageTitle" class="rn_AskConfirm">
    <h1><?=\RightNow\Utils\Config::msgGetFrom((4741));?></h1>
</section>
<section id="rn_PageContent" class="rn_AskConfirm">
    <div class="rn_Padding">
        <p>
            <?=\RightNow\Utils\Config::msgGetFrom((3843));?> <em>#<?=\RightNow\Utils\Connect::getFormattedObjectFieldValue(array
( 0 => 'Incident', 1 => 'ReferenceNumber', ), false);?><?=\RightNow\Utils\Url::getParameter('refno');?></em>
        </p>
        <p>
            <?=\RightNow\Utils\Config::msgGetFrom((3856));?>
        </p>
        <?if(
(\RightNow\Utils\Framework::isLoggedIn()) ):?>
        <p>
            <?=\RightNow\Utils\Config::msgGetFrom((4053));?>
            <br/><br/>
            <a href="/app/account/questions/list<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((4467));?></a>
        </p>
        <?else:?>
        <p>
            <?=\RightNow\Utils\Config::msgGetFrom((4048));?>
            <br/><br/>
            <a href="/app/utils/account_assistance<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((901));?></a>
        </p>
        <?endif;?>
    </div>
</section>
