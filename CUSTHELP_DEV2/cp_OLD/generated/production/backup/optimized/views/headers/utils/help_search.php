...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((4992)) . '', 'template'=>'standard.php'));
...
<div id="rn_PageTitle">
    <h1><?=\RightNow\Utils\Config::msgGetFrom((2026));?></h1>
</div>
<div id="rn_PageContent" class="rn_AnswerDetail">
    <div class="rn_Padding">
        <p><?=\RightNow\Utils\Config::msgGetFrom((4011));?></p>
        <p><?=\RightNow\Utils\Config::msgGetFrom((1570));?></p>
        <ul>
            <li><b><?=\RightNow\Utils\Config::msgGetFrom((3962));?></b> <?=\RightNow\Utils\Config::msgGetFrom((4014));?></li>
            <li><b><?=\RightNow\Utils\Config::msgGetFrom((3954));?></b> <?=\RightNow\Utils\Config::msgGetFrom((4013));?></li>
            <li><b><?=\RightNow\Utils\Config::msgGetFrom((3964));?></b> <?=\RightNow\Utils\Config::msgGetFrom((4006));?></li>
            <li><b><?=\RightNow\Utils\Config::msgGetFrom((3963));?></b> <?=\RightNow\Utils\Config::msgGetFrom((4016));?></li>
        </ul>
        <h2><?=\RightNow\Utils\Config::msgGetFrom((2563));?></h2>
        <p><?=\RightNow\Utils\Config::msgGetFrom((1189));?></p>
        <h2><?=\RightNow\Utils\Config::msgGetFrom((4602));?></h2>
        <p><?=\RightNow\Utils\Config::msgGetFrom((987));?></p>
    </div>
</div>
        </div>
<!--
