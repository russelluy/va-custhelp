...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((906)) . '', 'template'=>'standard.php', 'login_required'=>'true'));
...
<div id="rn_PageContent">
    <div class="rn_Overview">
            <h2><a class="rn_Profile" href="/app/account/profile<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((8453));?></a></h2>
            <div class="rn_Profile">
                <a href="/app/account/profile<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((4044));?></a><br/>
                <?if(
(!\RightNow\Utils\Framework::isPta() && !\RightNow\Utils\Framework::isOpenLogin()) ):?>
                    <a href="/app/account/change_password<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((1136));?></a>
                <?endif;?>
            </div>
    </div>
</div>
