...
<rn:condition url_parameter_check="incidents.c$typeofquestion==1857">
  ...
  <rn:widget path="input/FormInput" name="contacts.first_name" required="true" initial_focus="false"/>
  ...
  <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.elevatesubject" required="true" label_input="Elevate Help Request" always_show="true" radio="true" /> <br>
    ...
    <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredstart" required="false" min_year="2014" max_year="2015" label_input="Start" always_show="false" display_value="Incident.CustomFields.c.elevatesubject=1869" /> 
    <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredstart2" required="false" min_year="2014" max_year="2015" label_input="End" always_show="false" display_value="Incident.CustomFields.c.elevatesubject=1869" /> 
    ...
    <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredend" required="false" min_year="2014" max_year="2015" label_input="Start" always_show="false" display_value="Incident.CustomFields.c.elevatesubject=1869" />
    <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredend2" required="false" min_year="2014" max_year="2015" label_input="End" always_show="false" display_value="Incident.CustomFields.c.elevatesubject=1869" /> 
...
<rn:condition url_parameter_check="incidents.c$typeofquestion==1858">
  ...
  <rn:widget path="input/FormInput" name="contacts.first_name" required="true" initial_focus="false"/>
  <rn:widget path="input/FormInput" name="contacts.last_name" required="true" />
  <rn:widget path="input/IncidentTaskInput" />
...
<rn:condition url_parameter_check="incidents.c$typeofquestion==1866">
  ...
  <rn:widget path="custom/input/CustomTextInput" name="contacts.first_name" always_show="true" required="true" hideon_value="Incident.CustomFields.c.receipt_type=1901" />

  <rn:widget path="custom/input/CustomTextInput" name="contacts.last_name" always_show="true" required="true" hideon_value="Incident.CustomFields.c.receipt_type=1901" />
...
<h3> We'll keep your information on file for 30 days while we search.  If we find a match, we will notify you immediately</h3>
  ...
  <rn:widget path="input/DateInput" name="Incident.CustomFields.c.lost_object_date" min_year="2014" max_year="2015" required="false" />
  ...
  <rn:widget path="input/FileAttachmentUpload2" label_input="If possible please provide a picture" />
</rn:condition>
...
<rn:condition url_parameter_check="incidents.c$typeofquestion==1960">
  ...
  <rn:widget path="input/FormInput" name="contacts.email" required="true" label_input="#rn:msg:EMAIL_ADDR_LBL#" />
  <rn:widget path="input/FormInput" name="Incident.CustomFields.c.contactphone" required="false" label_input="Phone Number" />
  <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredstart" required="false" min_year="2014" max_year="2015" label_input="Departure Date" always_show="true" /> 
  <rn:widget path="custom/input/CustomDateInput" name="incidents.c$ffpdesiredend" required="false" min_year="2014" max_year="2015" label_input="Return Date" always_show="true" />
  ...
  <rn:widget path="input/FormInput" name="Incident.CustomFields.c.city_origin" required="false" label_input="Where are you flying from?" />
  <rn:widget path="input/FormInput" name="Incident.CustomFields.c.city_destination" required="false" label_input="Where are you flying to?" />
  ...
  <rn:widget path="custom/input/ToggleVisibleArea" name="togg" label="Please visit <a href='http://www.virginamerica.com/cms/special-assistance/service-animal-travel' target='_blank'>here</a> for documentation requirements" display_value="Incident.CustomFields.c.emotional_support_animal=1964" />
  
  <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.oxygen_use" required="false" label_input="Will you be using medical oxygen during the flight?" />
  <rn:widget path="custom/input/ToggleVisibleArea" name="togg" label="Please download, this form <a href='http://virginamerica.custhelp.com/ci/fattach/get/59157/0/filename/Portable+Oxygen+Concentrator+Med+Form.pdf' target='_blank'>here</a>, fill out and attach below" display_value="Incident.CustomFields.c.oxygen_use=1966" />
  <rn:widget path="custom/input/CustomFileAttachmentUpload" required="false" label_input="Medical Oxygen Documentation Form" display_value="Incident.CustomFields.c.oxygen_use=1966" />
 ...
 <div class="rn_Hidden">
  ...
  <rn:widget path="custom/input/CustomTextInput" name="incidents.thread" always_show="false" required="false" label_input="Let us know how we can help you?" display_value="Incident.CustomFields.c.special_assist_other=1968"/>
