...
RightNow.Form = RightNow.EventProvider.extend(/**@lends RightNow.Form*/{
    overrides:/**@ignore*/{
        constructor: function() {
            ...
            this._errorMessageDiv.setAttribute("aria-live", "assertive");
    ...
    */
    ...
    _createChallengeDiv: function() {
        this.Y.one("#" + this._challengeDivID) || this._formButton.insert(this.Y.Node.create("<div id='" + this._challengeDivID + "'>"), 'before');
    },
