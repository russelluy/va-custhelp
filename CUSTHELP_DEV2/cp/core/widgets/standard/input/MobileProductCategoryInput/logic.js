...
RightNow.Widgets.MobileProductCategoryInput = RightNow.Field.extend({
    overrides: {
        constructor: function() {
            ...
            this._baseID = this.baseSelector + "_" + this.data.attrs.data_type;
            ...
            if (this.data.js.initial) {
                for(var i = 0, currentItem; i < this.data.js.initial.length; i++) {
                    ...
                    this._selections.push({value: currentItem.id, label: this.Y.Escape.html(currentItem.label)});
                }
            ...
            else if (this.data.js.linkingOn && this.data.attrs.data_type === "Category" && this.data.js.linkMap && typeof this.data.js.linkMap[0] === "undefined") {
    ...
    */
    _createDialog: function(element) {
        ...
        this._dialog = RightNow.UI.Dialog.actionDialog(this.data.attrs.label_prompt, firstLevelItems, {navButtons: true, cssClass: "rn_MobileProductCategoryInput"});
    ...
    */
    _selectionMade: function(parentSelected) {
        ...
        this._commitSelection(this._selections);
        this._updateEventObject({data: {level: this._currentLevel, value: this._currentValue}});
    ...
    */
    ...
    _getSubLevelRequest: function(clickEvent) {
        if(!this._beingSelected) {
            ...
            if(this.data.js.linkingOn && this.data.attrs.data_type === "Product") {
                ...
                var maxDepth = this._maxDepth,
                    ...
                    alreadySelected = (currentSelections[level - 1]) ? currentSelections[level - 1].value :
                                     ((currentSelections[level - 2]) ? currentSelections[level - 2].value :
                                      false),
                    div = new EJS({text: this.getStatic().templates.view}).render({
    ...
    */
     ...
     */
    _displayRequiredError: function() {
    ...
    _updateEventObject: function(options) {
        if(!this._initialized) {
            this._eo = new RightNow.Event.EventObject(this, {data: {
                ...
                table: "Incident",
                cache: [],
                name: ((this.data.attrs.data_type === "Product") ? 'prod' : 'cat')
            }});
