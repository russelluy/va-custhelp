    ...
    */
    public function getAnswer()
    {
        ...
        if($answer->result){
            ...
            echo $answer->toJson($fieldsToReturn);
        }
        else{
            echo $answer->toJson();
        }
    ...
    public function submitAnswerFeedback()
    {
        ...
        if($incidentResult->result){
            echo json_encode(array('ID' => $incidentResult->result->ID));
            return;
        }
        if($incidentResult->error){
            echo json_encode(array('error' => $incidentResult->error->externalMessage));
            return;
        }
        echo json_encode(Config::getMessage(ERROR_REQUEST_ACTION_COMPLETED_MSG));
    }
    ...
    public function deleteNotification()
    {
        ...
        echo json_encode(array('error' => ($response->errors) ? (string) $response->error : ''));
    }
    ...
    public function checkForExistingContact()
    {
        ...
        if($this->input->post('checkForChallenge')){
            ...
            Framework::writeContentWithLengthAndExit(json_encode(false));
        }
