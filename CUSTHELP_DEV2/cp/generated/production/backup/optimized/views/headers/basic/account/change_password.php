...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((1136)) . '', 'template'=>'basic.php', 'login_required'=>'true', 'force_https'=>'true'));
...
<h1><?=\RightNow\Utils\Config::msgGetFrom((1136));?></h1>
<?=\RightNow\Utils\Url::getParameter('msg');?>
...
?>"><div>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.NewPassword','require_validation' => 'true','require_current_password' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormSubmit', array('on_success_url' => '/app/utils/submit/password_changed',));
?>
