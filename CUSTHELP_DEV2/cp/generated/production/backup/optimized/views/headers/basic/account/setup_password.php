...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((1963)) . '', 'template'=>'basic.php', 'login_required'=>'false', 'redirect_if_logged_in'=>'account/overview', 'force_https'=>'true'));
...
function _standard_login_ResetPassword_view ($data) {
extract($data);
...
array('name' => 'Contact.Login','required' => 'true','validate_on_blur' => 'true','initial_focus' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4846)) . '','sub_id' => 'login',));
?>
        <?if(!$this->data['attrs']['disable_password']):?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Contact.NewPassword','require_validation' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '','sub_id' => 'newAccountPassword',));
?>
        <?endif;?>
    <?else:?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput',
array('name' => 'Contact.NewPassword','initial_focus' => 'true','require_validation' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '','sub_id' => 'existingAccountPassword',));
?>
    <?endif;?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit',
array('on_success_url' => '' . $this->data['attrs']['on_success_url'] . '','error_location' => 'rn_' . $this->instanceID . '_ErrorLocation','sub_id' => 'submit',));
?>
    </form>
</div>
<? }
function __construct($attrs) {
parent::__construct($attrs);
$this->setAjaxHandlers(array( 'reset_password_ajax' => array( 'method' => 'performResetPassword', 'exempt_from_login_requirement' => true, ), ));
}
function getData() {
...
if(!$contact->Login && $this->data['loginRequired']) return;
if($contact->PasswordEmailExpirationTime === $expire) return;
}
}
}
}
}
echo '<br/>' . \RightNow\Utils\Config::getMessage((2564));
echo '<br/>' . sprintf(\RightNow\Utils\Config::getMessage((3394)), \RightNow\Utils\Config::getConfig((220), 'RNW_UI'), \RightNow\Utils\Config::getMessage((901)));
return false;
}
...
if(!$data) {
\RightNow\Utils\Framework::writeContentWithLengthAndExit(json_encode(\RightNow\Utils\Config::getMessage((2257))));
}
echo $this->CI->model('Field')->resetPassword($data, $parameters['pw_reset'])->toJson();
}
}
function _standard_login_ResetPassword_header() {
$result = array( 'js_name' => 'RightNow.Widgets.ResetPassword', 'library_name' => 'ResetPassword', 'view_func_name' => '_standard_login_ResetPassword_view', 'meta' => array ( 'controller_path' => 'standard/login/ResetPassword', 'view_path' => 'standard/login/ResetPassword', 'js_path' => 'standard/login/ResetPassword', 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/ResetPassword.css', 1 => 'assets/themes/standard/widgetCss/ResetPassword.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4369)', 'urlParameters' => array ( 'cred' => array ( 'name' => 'rn:msg:(33683)', 'description' => 'rn:msg:(1763)', 'example' => 'cred/aUVCTCILuy0gb5GpOaelD~qh005DiVsKZJQKwJ638InUGE9IgcSJD4SA**', ), ), ), 'contains' => array ( 0 => array ( 'widget' => 'standard/input/FormInput', 'versions' => array ( 0 => '1.1', ), ), 1 => array ( 'widget' => 'standard/input/FormSubmit', 'versions' => array ( 0 => '1.2', ), ), ), 'relativePath' => 'standard/login/ResetPassword', 'widget_name' => 'ResetPassword', ), );
$result['meta']['attributes'] = array( 'reset_password_ajax' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '/ci/ajax/widget', 'type' => 'AJAX', 'default' => '/ci/ajax/widget', 'inherited' => false, )), 'label_heading' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '', 'type' => 'STRING', 'default' => '', 'inherited' => false, )), 'disable_password' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => false, 'type' => 'BOOLEAN', 'default' => false, 'inherited' => false, )), 'on_success_url' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '/app/utils/submit/password_changed', 'type' => 'STRING', 'default' => '/app/utils/submit/password_changed', 'inherited' => false, )), );
return $result;
}
}
namespace RightNow\Widgets{
class BasicResetPassword extends ResetPassword {
function _standard_login_BasicResetPassword_view ($data) {
extract($data);
?><div id="rn_<?=$this->instanceID;?>" class="<?=$this->classList
?>">
    <div id="rn_<?=$this->instanceID;?>_ErrorLocation"></div>
...
array('name' => 'Contact.Login','required' => 'true','check_contact_exists' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4846)) . '','sub_id' => 'login',));
?>
        <?if(!$this->data['attrs']['disable_password']):?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.NewPassword','require_validation' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '','sub_id' => 'newAccountPassword',));
?>
        <?endif;?>
    <?else:?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput',
array('name' => 'Contact.NewPassword','require_validation' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((40564)) . '','label_validation' => '' . \RightNow\Utils\Config::msgGetFrom((4883)) . '','sub_id' => 'existingAccountPassword',));
?>
    <?endif;?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormSubmit',
array('on_success_url' => '' . $this->data['attrs']['on_success_url'] . '','sub_id' => 'submit',));
?>
...
function _standard_login_BasicResetPassword_header() {
$result = array( 'js_name' => '', 'library_name' => 'BasicResetPassword', 'view_func_name' => '_standard_login_BasicResetPassword_view', 'meta' => array ( 'controller_path' => 'standard/login/BasicResetPassword', 'view_path' => 'standard/login/BasicResetPassword', 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'none', ), ), 'contains' => array ( 0 => array ( 'widget' => 'standard/input/BasicFormInput', 'versions' => array ( 0 => '1.1', ), ), 1 => array ( 'widget' => 'standard/input/BasicFormSubmit', 'versions' => array ( 0 => '1.0', ), ), ), 'extends' => array ( 'widget' => 'standard/login/ResetPassword', 'versions' => array ( 0 => '1.1', ), 'components' => array ( 'php' => true, ), 'overrideViewAndLogic' => 'true', ), 'info' => array ( 'description' => 'rn:msg:(43069)', ), 'relativePath' => 'standard/login/BasicResetPassword', 'extends_info' => array ( 'controller' => array ( 0 => 'standard/login/ResetPassword', ), 'view' => array ( ), 'logic' => array ( ), 'js_templates' => array ( ), 'base_css' => array ( ), 'presentation_css' => array ( ), 'parent' => 'standard/login/ResetPassword', ), 'widget_name' => 'BasicResetPassword', 'extends_php' => array ( 0 => 'standard/login/ResetPassword', ), 'parent' => 'standard/login/ResetPassword', ), );
$result['meta']['attributes'] = array( 'post_handler' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => 'postRequest/resetPassword', 'type' => 'string', 'default' => 'postRequest/resetPassword', 'inherited' => false, )), 'label_heading' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '', 'type' => 'STRING', 'default' => '', 'inherited' => true, )), 'disable_password' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => false, 'type' => 'BOOLEAN', 'default' => false, 'inherited' => true, )), 'on_success_url' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '/app/utils/submit/password_changed', 'type' => 'STRING', 'default' => '/app/utils/submit/password_changed', 'inherited' => true, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
$result = array( 'js_name' => '', 'library_name' => 'BasicFormInput', 'view_func_name' => '_standard_input_BasicFormInput_view', 'meta' => array ( 'controller_path' => 'standard/input/BasicFormInput', 'view_path' => 'standard/input/BasicFormInput', 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'none', ), ), 'info' => array ( 'description' => 'rn:php:sprintf(\\RightNow\\Utils\\Config::getMessage((43282)), \'name\')', ), 'contains' => array ( 0 => array ( 'widget' => 'standard/input/BasicTextInput', 'versions' => array ( 0 => '1.0', ), ), 1 => array ( 'widget' => 'standard/input/BasicSelectionInput', 'versions' => array ( 0 => '1.0', ), ), 2 => array ( 'widget' => 'standard/input/BasicDateInput', 'versions' => array ( 0 => '1.2', 1 => '1.3', ), ), 3 => array ( 'widget' => 'standard/input/BasicPasswordInput', 'versions' => array ( 0 => '1.0', ), ), ), 'relativePath' => 'standard/input/BasicFormInput', 'widget_name' => 'BasicFormInput', ), );
...
<h1><?=\RightNow\Utils\Config::msgGetFrom((1963));?></h1>
<div>
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormStatusDisplay',
array());
?>
<br/>
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/login/BasicResetPassword', array('label_heading' => '' . \RightNow\Utils\Config::msgGetFrom((1415)) . '','on_success_url' => '' . '/app/account/profile/msg/' . urlencode(\RightNow\Utils\Config::getMessage((3848))) . '',));
?>
</div>
        <hr/>
        <div class="rn_CenterText">
