...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((908)) . '', 'template'=>'basic.php', 'login_required'=>'true', 'force_https'=>'true'));
...
<h1><?=\RightNow\Utils\Config::msgGetFrom((908));?></h1>
...
?>"><div>
    <div><?=\RightNow\Utils\Url::getParameter('msg');?></div>
    <h2><?=\RightNow\Utils\Config::msgGetFrom((4966));?></h2>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput',
array('name' => 'Contact.Login','required' => 'true','check_account_exists' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4846)) . '',));
?>
    <?if( (!\RightNow\Utils\Framework::isPta() && !\RightNow\Utils\Framework::isOpenLogin()) ):?>
        <?if( (\RightNow\Utils\Config::getConfig(193) == true) ):?>
            <div><a href="/app/<?=\RightNow\Utils\Config::configGetFrom((719));?><?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((1181));?></a><br/><br/></div>
        <?endif;?>
    <?endif;?>
    <h2><?=\RightNow\Utils\Config::msgGetFrom((4721));?></h2>
    <?if(
(\RightNow\Utils\Config::getConfig(134) == 1) ):?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Name.Last','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4793)) . '','required' => 'true',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Name.First','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4790)) . '','required' => 'true',));
?>
    <?else:?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Name.First','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4790)) . '','required' => 'true',));
?>
...
?>
    <?endif;?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput',
array('name' => 'Contact.Emails.PRIMARY.Address','required' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Phones.HOME.Number','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((24268)) . '',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Phones.OFFICE.Number','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((24272)) . '',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Contact.Phones.MOBILE.Number','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((24270)) . '',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicCustomAllInput', array('table' => 'Contact',));
?>
    <?if( (!\RightNow\Utils\Framework::isPta() && !\RightNow\Utils\Framework::isOpenLogin()) ):?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4968)) . '','on_success_url' => '/app/account/profile',));
?>
    <?endif;?>
<?=
