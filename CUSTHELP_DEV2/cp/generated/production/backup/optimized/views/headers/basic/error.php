...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((7587)) . '', 'template'=>'basic.php', 'login_required'=>'false'));
...
<?list($errorTitle,
$errorMessage) = \RightNow\Utils\Framework::getErrorMessageFromCode(\RightNow\Utils\Url::getParameter('error_id'));?>
<h1><?=$errorTitle;?></h1>
<p><?=$errorMessage;?></p>
        <hr/>
        <div class="rn_CenterText">
