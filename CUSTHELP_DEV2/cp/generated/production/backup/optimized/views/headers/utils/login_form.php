...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((4833)) . '', 'template'=>'standard.php', 'login_required'=>'false'));
...
$result = array( 'js_name' => 'RightNow.Widgets.LoginForm', 'library_name' => 'LoginForm', 'view_func_name' => '_standard_login_LoginForm_view', 'meta' => array ( 'controller_path' => 'standard/login/LoginForm', 'view_path' => 'standard/login/LoginForm', 'js_path' => 'standard/login/LoginForm', 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/LoginForm.css', 1 => 'assets/themes/standard/widgetCss/LoginForm.css', ), 'base_css' => array ( 0 => 'standard/login/LoginForm/base.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.1', 1 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4291)', 'urlParameters' => array ( 'redirect' => array ( 'name' => 'rn:msg:(3354)', 'description' => 'rn:msg:(1761)', 'example' => 'redirect/home', ), 'username' => array ( 'name' => 'rn:msg:(4846)', 'description' => 'rn:msg:(3199)', 'example' => 'username/JohnDoe', ), ), ), 'relativePath' => 'standard/login/LoginForm', 'widget_name' => 'LoginForm', ), );
...
.rn_LoginForm label.rn_Hidden{display:none;}
.rn_LoginForm.rn_ContentLoading{background:url(<?=FileSystem::getOptimizedAssetsDir();?>themes/standard/images/loading.gif) no-repeat center center;}
.rn_LoginForm input{margin-bottom:5px;}
.rn_LoginForm input[type="text"], .rn_LoginForm input[type="password"]{width:200px;}
.rn_LoginForm label{margin-bottom:5px;display:block;}
-->
</style>
...
<div id="rn_PageTitle" class="rn_Account">
    <h1><?=\RightNow\Utils\Config::msgGetFrom((2619));?></h1>
</div>
<div id="rn_PageContent" class="rn_Account">
    <div class="rn_Padding" >
        <div class="rn_Column rn_LeftColumn">
            <p><?=\RightNow\Utils\Config::msgGetFrom((903));?></p>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/login/LoginForm',
array('redirect_url' => '/app/account/overview','initial_focus' => 'true',));
?>
            <br/>
            <a href="/app/utils/account_assistance<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((2013));?></a>
        </div>
        <div class="rn_Column rn_RightColumn rn_CreateAccountInfo">
            <h2><?=\RightNow\Utils\Config::msgGetFrom((2847));?></h2>
            <ul>
                <li class="rn_Communicate"><?=\RightNow\Utils\Config::msgGetFrom((3565));?></li>
                <li class="rn_Feedback"><?=\RightNow\Utils\Config::msgGetFrom((2837));?></li>
                <li class="rn_Customize"><?=\RightNow\Utils\Config::msgGetFrom((1478));?></li>
            </ul>
            <button type="button" onclick="window.location='/app/utils/create_account/redirect/<?=urlencode(getUrlParm('redirect'));?><?=\RightNow\Utils\Url::sessionParameter();?>';"><?=\RightNow\Utils\Config::msgGetFrom((4905));?></button>
        </div>
    </div>
</div>
        </div>
