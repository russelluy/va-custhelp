...
<div id="rn_PageTitle" class="rn_LiveHelp">
    <h1><?=\RightNow\Utils\Config::msgGetFrom((4521));?></h1>
</div>
...
array('label_form_header' => '' . \RightNow\Utils\Config::msgGetFrom((1161)) . '',));
?>
...
?>
                <!-- optional fields -->
                <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/CustomAllInput', array('table' => 'incidents','chat_visible_only' => 'true',));
?>
            <br />
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/chat/ChatLaunchButton', array('error_location' => 'rn_ErrorLocation',));
?>
            <br /><br />
            </form>
       </div>
