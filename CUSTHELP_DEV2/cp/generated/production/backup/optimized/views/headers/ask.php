...
$result = array( 'js_name' => 'Custom.Widgets.input.ToggleVisibleArea', 'library_name' => 'ToggleVisibleArea', 'view_func_name' => '_custom_input_ToggleVisibleArea_view', 'meta' => array ( 'controller_path' => 'custom/input/ToggleVisibleArea', 'view_path' => 'custom/input/ToggleVisibleArea', 'js_path' => 'custom/input/ToggleVisibleArea', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/ToggleVisibleArea.css', ), 'base_css' => array ( 0 => 'custom/input/ToggleVisibleArea/base.css', ), 'version' => '1.0', 'requires' => array ( 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'extends' => array ( 'widget' => 'standard/input/TextInput', 'components' => array ( 'php' => true, 'view' => true, 'js' => true, 'css' => true, ), ), 'relativePath' => 'custom/input/ToggleVisibleArea', 'extends_info' => array ( 'controller' => array ( 0 => 'standard/input/TextInput', ), 'view' => array ( 0 => 'standard/input/TextInput', ), 'logic' => array ( 0 => 'standard/input/TextInput', ), 'js_templates' => array ( 0 => array ( 'label' => '<% if (label) { %> <rn:block id="preLabel"/> <label for="rn_<%= instanceID %>_<%= fieldName %>" id="rn_<%= instanceID %>_Label" class="rn_Label"> <%= label %> <% if (required) { %> <rn:block id="preRequired"/> <span class="rn_Required"> <%= requiredMarkLabel %></span><span class="rn_ScreenReaderOnly"><%= requiredLabel %></span> <rn:block id="postRequired"/> <% } %> <% if (hint) { %> <span class="rn_ScreenReaderOnly"><%= hint %></span> <% } %> </label> <rn:block id="postLabel"/><% } %>', 'labelValidate' => '<rn:block id="preValidateLabel"/><label for="rn_<%= instanceID %>_<%= fieldName %>_Validate" id="rn_<%= instanceID %>_<%= fieldName %>_LabelValidate" class="rn_Label"><%= label %><% if (required) { %> <rn:block id="preValidateRequired"/> <span class="rn_Required"> <%= requiredMarkLabel %></span><span class="rn_ScreenReaderOnly"><%= requiredLabel %></span> <rn:block id="postValidateRequired"/><% } %></label><rn:block id="postValidateLabel"/>', ), ), 'base_css' => array ( 0 => 'standard/input/TextInput/base.css', ), 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/TextInput.css', 1 => 'assets/themes/standard/widgetCss/TextInput.css', ), 'parent' => 'standard/input/TextInput', ), 'widget_name' => 'ToggleVisibleArea', 'extends_php' => array ( 0 => 'standard/input/TextInput', ), 'extends_js' => array ( 0 => 'standard/input/TextInput', ), 'extends_view' => array ( 0 => 'standard/input/TextInput', ), 'parent' => 'standard/input/TextInput', 'js_templates' => array ( 'label' => '<% if (label) { %>  <label for="rn_<%= instanceID %>_<%= fieldName %>" id="rn_<%= instanceID %>_Label" class="rn_Label"> <%= label %> <% if (required) { %>  <span class="rn_Required"> <%= requiredMarkLabel %></span><span class="rn_ScreenReaderOnly"><%= requiredLabel %></span>  <% } %> <% if (hint) { %> <span class="rn_ScreenReaderOnly"><%= hint %></span> <% } %> </label> <% } %>', 'labelValidate' => '<label for="rn_<%= instanceID %>_<%= fieldName %>_Validate" id="rn_<%= instanceID %>_<%= fieldName %>_LabelValidate" class="rn_Label"><%= label %><% if (required) { %>  <span class="rn_Required"> <%= requiredMarkLabel %></span><span class="rn_ScreenReaderOnly"><%= requiredLabel %></span> <% } %></label>', ), ), );
...
extract($data);
?><div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?>">
<div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?> rn_FormSubmit <? if(!$this->data['attrs']['always_show']): echo('rn_Hidden');
endif;?>">
...
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/SmartAssistantDialog',
array());
?>
<!--
Elevate
-->
<?if( (\RightNow\Utils\Url::getParameter('incidents.c$typeofquestion') == 1857) ):?>
  <h2>Elevate</h2>
  <h3>Need Elevate help?  Just fill out the form below and we'll respond within 24 hours.</h3>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.first_name','required' => 'true','initial_focus' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.last_name','required' => 'true',));
?>
...
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredstart','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'Start','always_show' => 'false','display_value' => 'Incident.CustomFields.c.elevatesubject=1869',));
?> 
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredstart2','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'End','always_show' => 'false','display_value' => 'Incident.CustomFields.c.elevatesubject=1869',));
?> 
...
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredend','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'Start','always_show' => 'false','display_value' => 'Incident.CustomFields.c.elevatesubject=1869',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredend2','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'End','always_show' => 'false','display_value' => 'Incident.CustomFields.c.elevatesubject=1869',));
?> 
...
?>
    ...
    <!-- show fields when elevate subject is
       Other id=1872 
    -->
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomTextInput', array('name' => 'Incident.CustomFields.c.altelevatenum1','required' => 'false','always_show' => 'false','label_input' => 'Additional Elevate Number','display_value' => 'Incident.CustomFields.c.elevatesubject=1872,Incident.CustomFields.c.elevatesubject=1868',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'incidents.thread','required' => 'false','label_input' => 'Let us know how we can help you?',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.last_name','required' => 'true',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/IncidentTaskInput', array());
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.last_name','required' => 'true',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.contactprimaryelevate','required' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.confirmationcode','label_input' => 'Virgin America Booking Confirmation Code','required' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.email','required' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '',));
...
?>
  ...
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomTextInput', array('name' => 'contacts.first_name','always_show' => 'true','required' => 'true','hideon_value' => 'Incident.CustomFields.c.receipt_type=1901',));
?>

  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomTextInput', array('name' => 'contacts.last_name','always_show' => 'true','required' => 'true','hideon_value' => 'Incident.CustomFields.c.receipt_type=1901',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.last_name','required' => 'true',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.contactprimaryelevate','label_input' => 'Elevate Number (If you have it handy)','required' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.confirmationcode','label_input' => 'Virgin America Booking Confirmation Code','required' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.email','required' => 'true','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '',));
...
?>
  ...
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/DateInput', array('name' => 'Incident.CustomFields.c.bestfare_date','min_year' => '2015','max_year' => '2016','required' => 'false','label_input' => 'Date of Travel','initial_focus' => 'false',));
?>
  <div style="display:none"><?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/SelectionInput', array('name' => 'incidents.c$cabinofservice','required' => 'false',));
?></div>
...
?>
  ...
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/DateInput', array('name' => 'Incident.CustomFields.c.lost_object_date','min_year' => '2014','max_year' => '2015','required' => 'false',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FileAttachmentUpload', array('label_input' => 'If possible please provide a picture',));
?>
<?endif;?>
...
-->
<?if(
(\RightNow\Utils\Url::getParameter('incidents.c$typeofquestion') == 1960) ):?>
  <h2>Special Request</h2>
  <h3>Do you have a special request?  Just fill out the form below and we'll respond within 24 hours.</h3>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.first_name','required' => 'true','initial_focus' => 'false',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.last_name','required' => 'true',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.contactphone','required' => 'false','label_input' => 'Phone Number',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredstart','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'Departure Date','always_show' => 'true',));
?> 
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomDateInput', array('name' => 'incidents.c$ffpdesiredend','required' => 'false','min_year' => '2014','max_year' => '2015','label_input' => 'Return Date','always_show' => 'true',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.city_origin','required' => 'false','label_input' => 'Where are you flying from?',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.city_destination','required' => 'false','label_input' => 'Where are you flying to?',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/ToggleVisibleArea', array('name' => 'togg','label' => 'Please visit <a href=\'http://virginamerica.custhelp.com/app/answers/detail/a_id/91\' target=\'_blank\'>here</a> for documentation requirements','display_value' => 'Incident.CustomFields.c.emotional_support_animal=1964',));
?>
  
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/SelectionRadioInput', array('name' => 'Incident.CustomFields.c.oxygen_use','required' => 'false','label_input' => 'Will you be using medical oxygen during the flight?',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/ToggleVisibleArea', array('name' => 'togg','label' => 'Please download the Medical Oxygen Documentation Form <a href=\'http://virginamerica.custhelp.com/ci/fattach/get/59157/0/filename/Portable+Oxygen+Concentrator+Med+Form.pdf\' target=\'_blank\'>here</a>. Then fill out and attach below. If you do not have the Medical Oxygen Documentation Form already filled out you will receive an automated email from us after clicking “Submit”. You can respond directly to this email with your completed form.','display_value' => 'Incident.CustomFields.c.oxygen_use=1966',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomFileAttachmentUpload', array('required' => 'false','label_input' => 'Please add any attachments here','display_value' => 'Incident.CustomFields.c.oxygen_use=1966',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/ToggleVisibleArea', array('name' => 'togg','label' => 'If you would like us to provide you with a wheelchair curbside, we ask that you or a person accompanying you contact a Virgin America teammate at the ticket counter, notifying them that you have arrived and that you would like the assistance of a wheelchair. A wheelchair will then be brought to you curbside.','display_value' => 'Incident.CustomFields.c.wheelchairassist=1961, Incident.CustomFields.c.wheelchairassist=1962, Incident.CustomFields.c.wheelchairassist=1963',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/SelectionRadioInput', array('name' => 'Incident.CustomFields.c.special_assist_other','required' => 'false','label_input' => 'Do you require assistance not listed above?',));
?>
...
?>
  ...
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomTextInput', array('name' => 'incidents.thread','always_show' => 'false','required' => 'false','label_input' => 'Let us know how we can help you?','display_value' => 'Incident.CustomFields.c.special_assist_other=2073',));
?>
...
<?if( (\RightNow\Utils\Url::getParameter('incidents.c$typeofquestion') != 1866) ):?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/CustomFormSubmit', array('label_button' => 'Fill the form to proceed','on_success_url' => '/app/ask_confirm','always_show' => 'true','display_value' => '','error_location' => 'rn_ErrorLocation',));
?>
<?endif;?>
    </form>
  </div>
...
( 0 => 'standard/login/LogoutLink', 1 => 'standard/login/LoginDialog', ), '/standard.js', '1441160703');?>"></script>
