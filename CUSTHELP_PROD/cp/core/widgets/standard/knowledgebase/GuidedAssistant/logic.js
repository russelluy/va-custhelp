...
********************************/
    ...
    */
    _createTextInputHTML: function(question) {
        ...
        return new EJS({text: this.getStatic().templates.textResponse}).render({
            ...
            level: this._currentLevel,
            requiredLabel: RightNow.Interface.getMessage("FIELD_REQUIRED_MARK_LBL"),
            screenReaderLabel: RightNow.Interface.getMessage("REQUIRED_LBL")
        });
    },
    ...
    */
    _appendElement: function(element, parentGuideID) {
        ...
        if (guide) {
            guide.appendChild(element).scrollIntoView();
         ...
         return {
             ...
             samePage: function() {
                 ...
                 try {
                     ...
                     this._samePageCachedResult = !window.opener ||
                         window.opener === window.self || (window.opener.RightNow && window.opener.RightNow.Chat);
                 }
                 catch (e) {
