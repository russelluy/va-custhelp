...
RightNow.UI.AbuseDetection.Default.prototype = {
    ...
    _createDefaultDialog: function(abuseResponse) {
        ...
        // with the same ID.
        abuseChallengeDiv = abuseChallengeDiv || Y.Node.create("<div id='" + this._abuseChallengeDivID + "'><div style='height: 129px'><img src='" + RightNow.Env('coreAssets') + "images/indicator.gif'></div></div>");
