 ...
 */
    ...
    _init: function(id)
    {
      ...
      var container = new YAHOO.util.Element('rn_'+this.instanceID); 
    ...
    */
    _getValue: function()
    {
      var el = new YAHOO.util.Element("rn_" + this.instanceID);
 ...
 */
    ...
    {
      var el = new YAHOO.util.Element("rn_" + args.instanceID);
      var arrRadio = el.getElementsByTagName("input"); 
      var rdoValue = 0;
      for(var i = 0; i < arrRadio.length; i++) {
