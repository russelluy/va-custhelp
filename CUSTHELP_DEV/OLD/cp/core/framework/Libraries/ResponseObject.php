...
class ResponseObject {
     ...
     */
    public function toJson(array $connectFields = array()) {
     ...
     *
     * @param ResponseError|string $error Error to add
     * @return void
    ...
    private function addError($error) {
        if (is_string($error)) {
            ...
            throw new \Exception('Errors must either be a string, or a ResponseError object.');
        }
    }
}
...
class ResponseError {
     ...
     */
    public function __construct($externalMessage, $errorCode = null, $source = null, $internalMessage = null, $extraDetails = null) {
