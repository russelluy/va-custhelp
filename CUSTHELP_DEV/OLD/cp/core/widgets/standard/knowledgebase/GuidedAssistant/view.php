    ...
    <div id="rn_<?= $this->instanceID ?>_Guide<?= $this->data['guideID'] ?>" class="rn_Guide">
        ...
        <? break;
            ...
            <div id="rn_<?= $this->instanceID ?>_Response<?= $questionID ?>" class="rn_Response rn_TextQuestion">
                ...
                <label class="rn_Label" for="rn_<?= $this->instanceID ?>_Response<?= $questionID ?>_<?= $response->responseID ?>"><?= $response->text ?> <span class="rn_Required" aria-hidden="true"> <?= \RightNow\Utils\Config::getMessage(FIELD_REQUIRED_MARK_LBL) ?> </span><span class="rn_ScreenReaderOnly" aria-hidden="true"><?= \RightNow\Utils\Config::getMessage(REQUIRED_LBL)?></span></label>
