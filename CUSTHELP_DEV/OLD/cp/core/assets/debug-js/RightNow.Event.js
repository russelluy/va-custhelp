        ...
        */
        ...
        EventBus: function()
        {
            ...
            function accessibleTreeViewGetSuccess(response, eventObject)
            {
                ...
                {
                    var results = RightNow.JSON.parse(response.responseText);
                    if (results.result)
                    {
                        eventObject.data.accessibleLinks = results.result;
            ...
            {
                var postData = {"filter_type": eventObject[0].data.data_type, "id": eventObject[0].data.id};
