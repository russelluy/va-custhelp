...
RightNow.Chat.Controller.ChatCommunicationsController.prototype = {
    ...
    /**
     * Sets the enduser activity status
     * @param {number} activityState
     */
    setEndUserActivityStatus: function(activityState)
    {
    ...
    handleChatPostMessageKeyUp: function(keyEvent, inputValue)
    {
        ...
        else if(inputValue !== "" && this._endUser.activityStatus !== ActivityState.RESPONDING)
    ...
    */
    logoff: function(isFromBrowserClose, isCancelled)
    {
        ...
        if(isFromBrowserClose)
        {
            ...
            if (this._chatCommunicator.isXDRTransaction())
                requestConfig.forceRnwRedirect = true;
        }
                        ...
                        try {
                            ...
                            switch(chatMessageType)
                            {
                                ...
                                case 'ChatRoleChangeNotification':
                                    ...
                                    break;
                                // Set the activity status (responding, listening, etc).
