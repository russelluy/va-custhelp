...
<rn:condition url_parameter_check="incidents.c$typeofquestion==1960">
  ...
  <rn:widget path="input/FormInput" name="Incident.CustomFields.c.city_destination_menu" required="false" label_input="Where are you flying to?" />
  ...
  <rn:widget path="custom/input/ToggleVisibleArea" name="togg" label="Please visit <a href='http://www.virginamerica.com/cms/special-assistance/service-animal-travel' target='_blank'>here</a> for the documentation requirements." display_value="Incident.CustomFields.c.emotional_support_animal=1964" />
