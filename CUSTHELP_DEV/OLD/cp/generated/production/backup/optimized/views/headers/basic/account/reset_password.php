...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((31587)) . '', 'template'=>'basic.php', 'login_required'=>'false', 'force_https'=>'true'));
...
<h1><?=\RightNow\Utils\Config::msgGetFrom((3411));?></h1>
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormStatusDisplay',
array());
?>
<div>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/login/BasicResetPassword', array());
?>
</div>
        <hr/>
        <div class="rn_CenterText">
