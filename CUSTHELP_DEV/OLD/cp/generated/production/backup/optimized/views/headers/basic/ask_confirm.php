...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((7121)) . '', 'template'=>'basic.php', 'clickstream'=>'incident_confirm'));
...
<p>
<?=\RightNow\Utils\Config::msgGetFrom((3843));?> 
    <b>
        <?if(
(\RightNow\Utils\Url::getParameter('i_id') == NULL) ):?>
            #<?=\RightNow\Utils\Url::getParameter('refno');?>
        <?else:?>
            <a href="/app/<?=\RightNow\Utils\Config::configGetFrom((227));?>/i_id/<?=\RightNow\Utils\Url::getParameter('i_id');?><?=\RightNow\Utils\Url::sessionParameter();?>">#<?=\RightNow\Utils\Connect::getFormattedObjectFieldValue(array
( 0 => 'Incident', 1 => 'ReferenceNumber', ), false);?></a>
        <?endif;?>
    </b>
</p>
<p>
...
(\RightNow\Utils\Framework::isLoggedIn()) ):?>
    <p>
        <?=\RightNow\Utils\Config::msgGetFrom((43200));?>
    </p>
    <?else:?>
    <p>
        <?=\RightNow\Utils\Config::msgGetFrom((43199));?>
    </p>
    <p>
        <?=\RightNow\Utils\Config::msgGetFrom((1673));?>
        <a href="/app/<?=\RightNow\Utils\Config::configGetFrom((220));?><?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((901));?></a>
    </p>
<?endif;?>
        <hr/>
        <div class="rn_CenterText">
