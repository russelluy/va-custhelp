...
<? if(isLoggedIn()) $this->data['readOnly'] = false;
?>
...
<? if($this->data['attrs']['checkbox']) $class = "rn_SelectionInput_chk";
else if($this->data['attrs']['checkbox2']) $class = "rn_SelectionInput_2";
else if($this->data['attrs']['radio']) $class = "rn_SelectionInput_radio";
else $class = "rn_SelectionInput";
?>
...
?>
    ...
    <?if($i === 1): ?>
        ...
        <? if($this->data['attrs']['checkbox'] || $this->data['attrs']['checkbox2']): ?>
            ...
            <label for="<?=$id;?>"><?
$this->data['attrs']['lbl'] ? print($this->data['attrs']['lbl']) : print($this->data['radioLabel'][$i])?>
...
if($this->data['js']['hint'] && $i===1):?> <span class="rn_ScreenReaderOnly"><?=$this->data['js']['hint']?></span><?endif;?></label><br/>
        <?
endif;
?>
    <? endif;
