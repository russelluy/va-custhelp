...
$i++):?>
    ...
    <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Year" class="rn_ScreenReaderOnly"><?=$this->data['yearLabel'];?><?
if($this->data['js']['hint'] && !$this->data['attrs']['hide_hint'] && $i===0):?> <?=$this->data['js']['hint']?><?endif?></label>
    <select id="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Year" <?=tabIndex($this->data['attrs']['tabindex'],
1 + $i);?>>
        <option value=''>--</option>
        <?
for($j = $this->data['maxYear'];
$j >= $this->data['minYear'];
$j--):?>
...
?>
    ...
    <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Month" class="rn_ScreenReaderOnly"><?=$this->data['monthLabel'];?><?
if($this->data['js']['hint'] && !$this->data['attrs']['hide_hint'] && $i===0):?> <?=$this->data['js']['hint']?><?endif;?></label>
    <select id="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Month" <?=tabIndex($this->data['attrs']['tabindex'],
1 + $i);?>>
        <option value=''>--</option>
        <?
for($j = 1;
...
?>
    <? else:?>
    <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Day" class="rn_ScreenReaderOnly"><?=$this->data['dayLabel'];?><?
if($this->data['js']['hint'] && !$this->data['attrs']['hide_hint'] && $i===0):?> <?=$this->data['js']['hint']?><?endif;?></label>
    <select id="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Day" <?=tabIndex($this->data['attrs']['tabindex'],
1 + $i);?>>
        <option value=''>--</option>
        <?
for($j = 1;
...
<?
if($this->field->data_type === (2) && 0):?>
    <? ?>
    <label for="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Hour" class="rn_ScreenReaderOnly"><?=$this->data['hourLabel'];?></label>
    <select id="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Hour" <?=tabIndex($this->data['attrs']['tabindex'],
1 + $i);?>>
        <option value=''>--</option>
        <?
for($j = 0;
...
?>
    ...
    <select id="rn_<?=$this->instanceID;?>_<?=$this->data['js']['name'];?>_Minute" <?=tabIndex($this->data['attrs']['tabindex'],
2 + $i);?>>
        <option value=''>--</option>
        <?
for($j = 0;
