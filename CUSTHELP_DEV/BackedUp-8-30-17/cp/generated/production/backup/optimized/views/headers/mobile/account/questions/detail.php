...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . SEO::getDynamicTitle('incident', getUrlParm('i_id')) . '', 'template'=>'mobile.php', 'login_required'=>'true', 'clickstream'=>'incident_view'));
...
$result = array( 'js_name' => '', 'library_name' => 'DataDisplay', 'view_func_name' => '_standard_output_DataDisplay_view', 'meta' => array ( 'controller_path' => 'standard/output/DataDisplay', 'view_path' => 'standard/output/DataDisplay', 'version' => '1.2.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', 1 => '3.3', 2 => '3.4', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', 2 => 'none', ), ), 'info' => array ( 'description' => 'rn:msg:(41981)', 'urlParameters' => array ( 'kw' => array ( 'name' => 'rn:msg:(13864)', 'description' => 'rn:msg:(3918)', 'example' => 'kw/search', ), 'a_id' => array ( 'name' => 'rn:msg:(4653)', 'description' => 'rn:msg:(993)', 'example' => 'a_id/3', ), 'i_id' => array ( 'name' => 'rn:msg:(10071)', 'description' => 'rn:msg:(2166)', 'example' => 'i_id/7', ), ), ), 'contains' => array ( 0 => array ( 'widget' => 'standard/output/FileListDisplay', 'versions' => array ( 0 => '1.1', 1 => '1.2', ), ), 1 => array ( 'widget' => 'standard/output/ProductCategoryDisplay', 'versions' => array ( 0 => '1.1', ), ), 2 => array ( 'widget' => 'standard/output/IncidentThreadDisplay', 'versions' => array ( 0 => '1.0', 1 => '1.1', 2 => '1.2', ), ), 3 => array ( 'widget' => 'standard/output/FieldDisplay', 'versions' => array ( 0 => '1.1', ), ), ), 'relativePath' => 'standard/output/DataDisplay', 'widget_name' => 'DataDisplay', ), );
$result['meta']['attributes'] = array( );
return $result;
}
}
...
function _standard_output_CustomAllDisplay_view ($data) {
extract($data);
?>
<? foreach($this->data['fields'] as $fieldName): ?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => '' . $fieldName . '','sub_id' => '' . "display_$fieldName" . '',));
?>
<? endforeach;
?>
<? }
...
function _standard_output_CustomAllDisplay_header() {
$result = array( 'js_name' => '', 'library_name' => 'CustomAllDisplay', 'view_func_name' => '_standard_output_CustomAllDisplay_view', 'meta' => array ( 'controller_path' => 'standard/output/CustomAllDisplay', 'view_path' => 'standard/output/CustomAllDisplay', 'version' => '1.1.2', 'requires' => array ( 'framework' => array ( 0 => '3.2', 1 => '3.3', 2 => '3.4', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', 2 => 'none', ), ), 'info' => array ( 'description' => 'rn:msg:(24179)', 'urlParameters' => array ( 'a_id' => array ( 'name' => 'rn:msg:(4653)', 'description' => 'rn:msg:(993)', 'example' => 'a_id/3', ), 'i_id' => array ( 'name' => 'rn:msg:(10071)', 'description' => 'rn:msg:(2166)', 'example' => 'i_id/7', ), ), ), 'extends' => array ( 'widget' => 'standard/input/CustomAllInput', 'versions' => array ( 0 => '1.0', 1 => '1.1', ), 'components' => array ( 'php' => true, ), 'overrideViewAndLogic' => true, ), 'contains' => array ( 0 => array ( 'widget' => 'standard/output/DataDisplay', 'description' => 'rn:msg:(46194)', 'versions' => array ( 0 => '1.1', 1 => '1.2', ), ), ), 'relativePath' => 'standard/output/CustomAllDisplay', 'extends_info' => array ( 'controller' => array ( 0 => 'standard/input/CustomAllInput', ), 'view' => array ( ), 'logic' => array ( ), 'js_templates' => array ( ), 'base_css' => array ( ), 'presentation_css' => array ( ), 'parent' => 'standard/input/CustomAllInput', ), 'widget_name' => 'CustomAllDisplay', 'extends_php' => array ( 0 => 'standard/input/CustomAllInput', ), 'parent' => 'standard/input/CustomAllInput', ), );
$result['meta']['attributes'] = array( 'highlight' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => true, 'type' => 'boolean', 'default' => true, 'inherited' => false, )), 'table' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => null, 'type' => 'OPTION', 'default' => null, 'options' => array(0 => 'answers', 1 => 'Answer', 2 => 'contacts', 3 => 'Contact', 4 => 'incidents', 5 => 'Incident', ), 'required' => true, 'inherited' => false, )), 'chat_visible_only' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => false, 'type' => 'boolean', 'default' => false, 'inherited' => true, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
$result = array( 'js_name' => '', 'library_name' => 'FileListDisplay', 'view_func_name' => '_standard_output_FileListDisplay_view', 'meta' => array ( 'controller_path' => 'standard/output/FileListDisplay', 'view_path' => 'standard/output/FileListDisplay', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/FileListDisplay.css', 1 => 'assets/themes/basic/widgetCss/FileListDisplay.css', 2 => 'assets/themes/mobile/widgetCss/FileListDisplay.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.1', 1 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', 2 => 'none', ), ), 'info' => array ( 'description' => 'rn:msg:(41979)', 'urlParameters' => array ( 'a_id' => array ( 'name' => 'rn:msg:(4653)', 'description' => 'rn:msg:(993)', 'example' => 'a_id/3', ), 'i_id' => array ( 'name' => 'rn:msg:(10071)', 'description' => 'rn:msg:(2166)', 'example' => 'i_id/7', ), ), ), 'relativePath' => 'standard/output/FileListDisplay', 'widget_name' => 'FileListDisplay', ), );
...
$result = array( 'js_name' => '', 'library_name' => 'ProductCategoryDisplay', 'view_func_name' => '_standard_output_ProductCategoryDisplay_view', 'meta' => array ( 'controller_path' => 'standard/output/ProductCategoryDisplay', 'view_path' => 'standard/output/ProductCategoryDisplay', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/ProductCategoryDisplay.css', 1 => 'assets/themes/basic/widgetCss/ProductCategoryDisplay.css', 2 => 'assets/themes/mobile/widgetCss/ProductCategoryDisplay.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.1', 1 => '3.2', 2 => '3.3', 3 => '3.4', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', 2 => 'none', ), ), 'info' => array ( 'description' => 'rn:msg:(51783)', 'urlParameters' => array ( 'a_id' => array ( 'name' => 'rn:msg:(4653)', 'description' => 'rn:msg:(993)', 'example' => 'a_id/3', ), 'i_id' => array ( 'name' => 'rn:msg:(10071)', 'description' => 'rn:msg:(2166)', 'example' => 'i_id/7', ), ), ), 'relativePath' => 'standard/output/ProductCategoryDisplay', 'widget_name' => 'ProductCategoryDisplay', ), );
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/mobile/account/questions/detail.themes.mobile.css' rel='stylesheet' type='text/css' media='all'/>
...
<section id="rn_PageTitle" class="rn_QuestionDetail">
    <h1><?=\RightNow\Utils\Connect::getFormattedObjectFieldValue(array
( 0 => 'Incident', 1 => 'Subject', ), true);?></h1>
</section>
<section id="rn_PageContent" class="rn_QuestionDetail">
    <?if(
(!\RightNow\Utils\Framework::hasClosedIncidentReopenDeadlinePassed(168)) ):?>
        <div class="rn_Module">
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/navigation/Accordion', array('toggle' => 'rn_QuestionUpdate',));
?>
            <h2 id="rn_QuestionUpdate"><?=\RightNow\Utils\Config::msgGetFrom((4043));?><span class="rn_Expand"></span></h2>
...
array('name' => 'incidents.thread','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((913)) . '','initial_focus' => 'true',));
?>
                <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'incidents.status','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((1685)) . '',));
?>
                <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4550)) . '','on_success_url' => '/app/account/questions/list','error_location' => 'rn_ErrorLocation',));
?>
            </form>
        </div>
    <?else:?>
        <h4><?=\RightNow\Utils\Config::msgGetFrom((2180));?></h4>
    <?endif;?>
    <div class="rn_Module">
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/navigation/Accordion',
array('toggle' => 'rn_QuestionThread',));
?>
        <h2 id="rn_QuestionThread"><?=\RightNow\Utils\Config::msgGetFrom((1292));?><span class="rn_Expand"></span></h2>
        <div class="rn_Hidden">
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay',
array('name' => 'incidents.thread','label' => '',));
?>
        </div>
    </div>
    <div class="rn_Module">
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/navigation/Accordion', array('toggle' => 'rn_QuestionDetails',));
?>
        <h2 id="rn_QuestionDetails"><?=\RightNow\Utils\Config::msgGetFrom((916));?><span class="rn_Expand"></span></h2>
        <div class="rn_Hidden rn_Padding">
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay',
array('name' => 'incidents.contact_email','label' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.ref_no','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.status','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.created','label' => '' . \RightNow\Utils\Config::msgGetFrom((4920)) . '','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.updated','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.prod','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.cat','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.fattach','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4657)) . '','left_justify' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/CustomAllDisplay', array('table' => 'incidents','left_justify' => 'true',));
?>
        </div>
    </div>
</section>
