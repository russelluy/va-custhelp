...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4979)) . '', 'template'=>'basic.php', 'login_required'=>'true'));
...
<p><b><?=\RightNow\Utils\Config::msgGetFrom((32426));?></b></p>
<p><?=\RightNow\Utils\Config::msgGetFrom((4454));?></p>
        <hr/>
        <div class="rn_CenterText">
            <?if(
