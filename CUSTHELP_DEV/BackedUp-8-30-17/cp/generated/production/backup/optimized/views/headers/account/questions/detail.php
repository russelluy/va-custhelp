...
get_instance()->_checkMeta(array('title'=>'' . SEO::getDynamicTitle('incident', getUrlParm('i_id')) . '', 'template'=>'standard.php', 'login_required'=>'true', 'clickstream'=>'incident_view'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/account/questions/detail.themes.standard.css' rel='stylesheet' type='text/css' media='all'/>
...
(!\RightNow\Utils\Framework::hasClosedIncidentReopenDeadlinePassed(168)) ):?>
            <h2 class="rn_HeadingBar"><?=\RightNow\Utils\Config::msgGetFrom((4043));?></h2>
...
?>
                    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FileAttachmentUpload', array('label_input' => '' . \RightNow\Utils\Config::msgGetFrom((1028)) . '',));
?>
                    <div id="rn_FileAttach">
                        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.fattach','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4657)) . '',));
?>
                    </div>
...
?>
                    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('on_success_url' => '/app/account/questions/list','error_location' => 'rn_ErrorLocation',));
?>
            </form>
        <?else:?>
            <h2 class="rn_HeadingBar"><?=\RightNow\Utils\Config::msgGetFrom((2180));?></h2>
        <?endif;?>
        <h2 class="rn_HeadingBar"><?=\RightNow\Utils\Config::msgGetFrom((1292));?></h2>
...
?>
        ...
        <h2 class="rn_HeadingBar"><?=\RightNow\Utils\Config::msgGetFrom((916));?></h2>
        <div id="rn_AdditionalInfo">
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay',
array('name' => 'incidents.contact_email','label' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.ref_no',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.status',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.created','label' => '' . \RightNow\Utils\Config::msgGetFrom((4920)) . '',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.updated',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.closed',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.prod',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.cat',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'incidents.fattach','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((4657)) . '',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/CustomAllDisplay', array('table' => 'incidents',));
?>
        </div>
