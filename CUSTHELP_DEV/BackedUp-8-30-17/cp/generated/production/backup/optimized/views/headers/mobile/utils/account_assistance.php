...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((901)) . '', 'template'=>'mobile.php', 'login_required'=>'false'));
...
$result = array( 'js_name' => 'RightNow.Widgets.EmailCredentials', 'library_name' => 'EmailCredentials', 'view_func_name' => '_standard_login_EmailCredentials_view', 'meta' => array ( 'controller_path' => 'standard/login/EmailCredentials', 'view_path' => 'standard/login/EmailCredentials', 'js_path' => 'standard/login/EmailCredentials', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/EmailCredentials.css', 1 => 'assets/themes/mobile/widgetCss/EmailCredentials.css', ), 'version' => '1.2.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4327)', 'urlParameters' => array ( 'Contact.Emails.PRIMARY.Address' => array ( 'name' => 'rn:msg:(41568)', 'description' => 'rn:msg:(41628)', 'example' => 'Contact.Emails.PRIMARY.Address/test@example.com', ), ), ), 'relativePath' => 'standard/login/EmailCredentials', 'widget_name' => 'EmailCredentials', ), );
...
.rn_EmailCredentials .rn_LoadingIndicator{background-image:url(<?=FileSystem::getOptimizedAssetsDir();?>themes/mobile/images/indicator.gif);background-repeat:no-repeat;background-position:left center;min-height:16px;min-width:16px;}
.rn_EmailCredentials input[type="text"]{margin:10px auto;}
-->
</style>
...
( 0 => 'standard/login/EmailCredentials', ), '/mobile/utils/account_assistance.js', '1495130941');?>"></script>
