...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4527)) . '', 'template'=>'basic.php', 'clickstream'=>'answer_list'));
...
$result = array( 'js_name' => '', 'library_name' => 'BasicDisplaySearchFilters', 'view_func_name' => '_standard_search_BasicDisplaySearchFilters_view', 'meta' => array ( 'controller_path' => 'standard/search/BasicDisplaySearchFilters', 'view_path' => 'standard/search/BasicDisplaySearchFilters', 'presentation_css' => array ( 0 => 'assets/themes/basic/widgetCss/BasicDisplaySearchFilters.css', ), 'version' => '1.0.2', 'requires' => array ( 'framework' => array ( 0 => '3.1', 1 => '3.2', 2 => '3.3', 3 => '3.4', ), 'jsModule' => array ( 0 => 'none', ), ), 'info' => array ( 'category' => array ( 0 => 'Basic', 1 => 'Report Search', ), 'description' => 'rn:msg:(4191)', 'urlParameters' => array ( 'filter_name' => array ( 'name' => 'rn:msg:(1986)', 'description' => 'rn:msg:(4506)', 'example' => 'p/1,4,6', ), ), ), 'relativePath' => 'standard/search/BasicDisplaySearchFilters', 'widget_name' => 'BasicDisplaySearchFilters', ), );
$result['meta']['attributes'] = array( 'label_all_products' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => \RightNow\Utils\Config::getMessage(843), 'type' => 'STRING', 'default' => \RightNow\Utils\Config::getMessage(843), 'inherited' => false, )), 'label_all_categories' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => \RightNow\Utils\Config::getMessage(842), 'type' => 'STRING', 'default' => \RightNow\Utils\Config::getMessage(842), 'inherited' => false, )), 'report_id' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => (176), 'type' => 'INT', 'default' => (176), 'min' => 1, 'inherited' => false, )), 'add_params_to_url' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => 'p,c,kw', 'type' => 'STRING', 'default' => 'p,c,kw', 'inherited' => false, )), 'static_filter' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '', 'type' => 'STRING', 'default' => '', 'inherited' => false, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
?>
    <?if( (\RightNow\Utils\Url::getParameter('selectFilter') == 'product') ):?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/BasicProductCategorySearchFilter', array());
?>
    <?else:?>
        <?if( (\RightNow\Utils\Url::getParameter('selectFilter') == 'category') ):?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/BasicProductCategorySearchFilter', array('filter_type' => 'categories','report_page_url' => '/app/answers/list','label_clear_filters_button' => '' . \RightNow\Utils\Config::msgGetFrom((43193)) . '',));
?>
        <?else:?>
...
?>
            <div>
                <a href="/app/answers/list/selectFilter/product/<?=\RightNow\Utils\Url::getParameterWithKey('c');?>/<?=\RightNow\Utils\Url::getParameterWithKey('kw');?><?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((2562));?></a><br/>
                <a href="/app/answers/list/selectFilter/category/<?=\RightNow\Utils\Url::getParameterWithKey('p');?>/<?=\RightNow\Utils\Url::getParameterWithKey('kw');?><?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((2561));?></a>
            </div>
