...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4525)) . '', 'template'=>'basic.php', 'clickstream'=>'home'));
...
function _standard_reports_TopAnswers_view ($data) {
extract($data);
?><?php ?>
...
?>
                    <a href="<?=$this->data['attrs']['answers_detail_url'] . "/a_id/$answer->ID" . \RightNow\Utils\Url::sessionParameter();?>" <?=$target;?>><?=\RightNow\Utils\Text::escapeHtml($answer->Title,
false);?></a>
                </span>
            <?
...
function _standard_reports_TopAnswers_header() {
$result = array( 'js_name' => '', 'library_name' => 'TopAnswers', 'view_func_name' => '_standard_reports_TopAnswers_view', 'meta' => array ( 'controller_path' => 'standard/reports/TopAnswers', 'view_path' => 'standard/reports/TopAnswers', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/TopAnswers.css', 1 => 'assets/themes/basic/widgetCss/TopAnswers.css', 2 => 'assets/themes/mobile/widgetCss/TopAnswers.css', ), 'base_css' => array ( 0 => 'standard/reports/TopAnswers/base.css', ), 'version' => '1.0.2', 'requires' => array ( 'framework' => array ( 0 => '3.1', 1 => '3.2', 2 => '3.3', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', 2 => 'none', ), ), 'info' => array ( 'category' => array ( 0 => 'Knowledge Foundation', ), 'description' => 'rn:msg:(44666)', ), 'relativePath' => 'standard/reports/TopAnswers', 'widget_name' => 'TopAnswers', ), );
$result['meta']['attributes'] = array( 'limit' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => 10, 'type' => 'INT', 'default' => 10, 'min' => 1, 'max' => 10, 'inherited' => false, )), 'product_filter_id' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => null, 'type' => 'INT', 'default' => null, 'min' => 1, 'inherited' => false, )), 'category_filter_id' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => null, 'type' => 'INT', 'default' => null, 'min' => 1, 'inherited' => false, )), 'show_excerpt' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => false, 'type' => 'BOOL', 'default' => false, 'inherited' => false, )), 'excerpt_max_length' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => 256, 'type' => 'INT', 'default' => 256, 'max' => 256, 'inherited' => false, )), 'answers_detail_url' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '/app/' . \RightNow\Utils\Config::getConfig((222)), 'type' => 'STRING', 'default' => '/app/' . \RightNow\Utils\Config::getConfig((222)), 'inherited' => false, )), 'url_type_target' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '_blank', 'type' => 'STRING', 'default' => '_blank', 'inherited' => false, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
$result = array( 'js_name' => '', 'library_name' => 'ProductCategoryList', 'view_func_name' => '_standard_search_ProductCategoryList_view', 'meta' => array ( 'controller_path' => 'standard/search/ProductCategoryList', 'view_path' => 'standard/search/ProductCategoryList', 'presentation_css' => array ( 0 => 'assets/themes/standard/widgetCss/ProductCategoryList.css', 1 => 'assets/themes/mobile/widgetCss/ProductCategoryList.css', ), 'base_css' => array ( 0 => 'standard/search/ProductCategoryList/base.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'standard', ), ), 'info' => array ( 'description' => 'rn:msg:(4278)', ), 'relativePath' => 'standard/search/ProductCategoryList', 'widget_name' => 'ProductCategoryList', ), );
...
.rn_TopAnswers ul{padding: 0;}
.rn_TopAnswers ul li{list-style: none;margin-bottom: 10px;}
.rn_MobileProductCategoryList .rn_HierList{margin-bottom: 10px;}
-->
</style>
...
array('label_text' => '','report_page_url' => '/app/answers/list',));
?>
<h2><?=\RightNow\Utils\Config::msgGetFrom((4586));?></h2>
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/reports/TopAnswers',
array('limit' => '5',));
?>
<h2><?=\RightNow\Utils\Config::msgGetFrom((1889));?></h2>
