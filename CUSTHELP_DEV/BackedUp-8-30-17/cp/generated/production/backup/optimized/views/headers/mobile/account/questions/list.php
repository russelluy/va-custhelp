...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((3854)) . '', 'template'=>'mobile.php', 'clickstream'=>'incident_list', 'login_required'=>'true'));
...
.rn_SearchButton .rn_SubmitButton{background-color:#0E53A7;color:#FFF;cursor:pointer;font-weight:bold;}
...
.rn_ResultInfo .rn_Spell a{color:#039;font:italic bold medium arial, sans-serif;}
...
.rn_Paginator{clear:left;padding:10px 0;font-size:140%;}
.rn_Paginator a, .rn_Paginator .rn_CurrentPage{line-height:2em;margin-right:4px;padding:4px;}
.rn_Paginator img{vertical-align:middle;border:none;}
...
.rn_Paginator a:focus{background:#EBEFF5;}
.rn_Paginator .rn_ForwardImageLink, .rn_Paginator .rn_BackImageLink{border:none;background:none;}
-->
</style>
...
<section id="rn_PageTitle" class="rn_QuestionList">
    <div id="rn_SearchControls">
        <h1><?=\RightNow\Utils\Config::msgGetFrom((3520));?></h1>
        <form method="post" action="" onsubmit="return false">
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/KeywordText',
array('label_text' => '','report_id' => '159','initial_focus' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/SearchButton', array('report_id' => '159','icon_path' => 'images/icons/search.png',));
?>
        </form>
    </div>
</section>
<section id="rn_PageContent" class="rn_QuestionList">
    <div class="rn_Padding">
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/reports/ResultInfo', array('report_id' => '159','add_params_to_url' => 'p,c',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/reports/MobileMultiline', array('report_id' => '159',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/reports/Paginator', array('report_id' => '159',));
?>
    </div>
</section>
        </section>
...
( 0 => '/euf/core/3.2.6/js/6.232/min/widgetHelpers/EventProvider.js', 1 => '/euf/core/3.2.6/js/6.232/min/widgetHelpers/SearchFilter.js', 2 => 'standard/search/KeywordText', 3 => 'standard/search/SearchButton', 4 => 'standard/reports/ResultInfo', 5 => 'standard/reports/Paginator', 6 => 'standard/reports/MobileMultiline', ), '/mobile/account/questions/list.js', '1495130941');?>"></script>
