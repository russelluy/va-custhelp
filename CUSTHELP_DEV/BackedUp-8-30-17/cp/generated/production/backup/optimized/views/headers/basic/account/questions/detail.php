...
get_instance()->_checkMeta(array('javascript_module'=>'none', 'title'=>'' . \RightNow\Libraries\SEO::getDynamicTitle('incident', \RightNow\Utils\Url::getParameter('i_id')) . '', 'template'=>'basic.php', 'login_required'=>'true', 'clickstream'=>'incident_view', 'force_https'=>'true'));
...
(!\RightNow\Utils\Framework::hasClosedIncidentReopenDeadlinePassed(168)) ):?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormStatusDisplay', array());
?>
    <form method='post' action='/app/account/questions/detail/i_id/<?=\RightNow\Utils\Url::getParameter('i_id');?>'><div>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput',
array('name' => 'Incident.StatusWithType.Status','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((1685)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormInput', array('name' => 'Incident.Threads','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((913)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/BasicFormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4550)) . '','on_success_url' => '/app/account/questions/list',));
?>
    <?= \RightNow\Utils\Widgets::addServerConstraints('/app/account/questions/detail/i_id/' . \RightNow\Utils\Url::getParameter('i_id') . '', 'postRequest/sendForm');
?></div></form>
    <?else:?>
        <h2><?=\RightNow\Utils\Config::msgGetFrom((43366));?></h2>
    <?endif;?>
</div>
<div>
    <h2><?=\RightNow\Utils\Config::msgGetFrom((1292));?></h2>
    <div>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay',
array('name' => 'Incident.Threads','label' => '',));
?>
    </div>
</div>
<div>
    <h2><?=\RightNow\Utils\Config::msgGetFrom((916));?></h2>
    <div>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay',
array('name' => 'Incident.PrimaryContact.Emails.PRIMARY.Address','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4547)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.ReferenceNumber','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((9636)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.StatusWithType.Status','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4668)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.CreatedTime','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4920)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.UpdatedTime','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((6861)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.Product','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4594)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.Category','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4574)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/DataDisplay', array('name' => 'Incident.FileAttachments','left_justify' => 'true','label' => '' . \RightNow\Utils\Config::msgGetFrom((4657)) . '',));
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/output/CustomAllDisplay', array('table' => 'Incident','left_justify' => 'true',));
?>
    </div>
</div>
        <hr/>
