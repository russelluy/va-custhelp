...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((908)) . '', 'template'=>'standard.php', 'login_required'=>'true'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/account/profile.themes.standard.css' rel='stylesheet' type='text/css' media='all'/>
...
<div id="rn_PageContent" class="rn_Profile">
    <div class="rn_Padding">
        <div class="rn_Required rn_LargeText"><?=\RightNow\Utils\Url::getParameter('msg');?></div>
        <form id="rn_CreateAccount" method="post" action="" onsubmit="return false;">
            <div id="rn_ErrorLocation"></div>
            <h2><?=\RightNow\Utils\Config::msgGetFrom((4966));?></h2>
            <fieldset>
                <legend><?=\RightNow\Utils\Config::msgGetFrom((4966));?></legend>
...
?>
            <?if( (!\RightNow\Utils\Framework::isPta() && !\RightNow\Utils\Framework::isOpenLogin()) ):?>
                <a href="/app/account/change_password<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((1181));?></a>
            <?endif;?>
            </fieldset>
            <h2><?=\RightNow\Utils\Config::msgGetFrom((4721));?></h2>
            <fieldset>
                <legend><?=\RightNow\Utils\Config::msgGetFrom((4721));?></legend>
