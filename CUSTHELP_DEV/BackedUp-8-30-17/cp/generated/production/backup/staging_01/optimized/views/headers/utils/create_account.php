...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((4872)) . '', 'template'=>'standard.php', 'login_required'=>'false'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/utils/create_account.themes.standard.css' rel='stylesheet' type='text/css' media='all'/>
...
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4849)) . '','on_success_url' => '/app/account/overview','error_location' => 'rn_ErrorLocation',));
?>
        </form>
    </div>
</div>
