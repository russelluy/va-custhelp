...
RightNow.Widget.CustomSelectionInput = function(data, instanceID){

    this.data = data;
    this.instanceID = instanceID;
    this._formErrorLocation = null;

    this._parentContainer =  document.getElementById("rn_" + this.instanceID).parentNode;
    ...
    {
        YAHOO.util.Event.addListener(this._inputField,"change", this._selectionChanged, this);
    }
    RightNow.Event.subscribe('evt_questiontype', this._doAction, this);
};

RightNow.Widget.CustomSelectionInput.prototype = {
/**
 * ----------------------------------------------
