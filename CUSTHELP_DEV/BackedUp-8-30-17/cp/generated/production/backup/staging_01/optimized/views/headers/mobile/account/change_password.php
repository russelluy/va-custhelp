...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((1136)) . '', 'template'=>'mobile.php', 'login_required'=>'true'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/mobile/account/change_password.themes.mobile.css' rel='stylesheet' type='text/css' media='all'/>
...
array('name' => 'contacts.password','required' => 'false','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((8774)) . '','initial_focus' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.password_new','required' => 'false','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((9225)) . '',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.password_verify','required' => 'false','label_input' => '' . \RightNow\Utils\Config::msgGetFrom((9224)) . '',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('on_success_url' => '/app/utils/submit/password_changed','error_location' => 'rn_ErrorLocation',));
?>
        </form>
    </div>
</section>
