...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((1963)) . '', 'template'=>'mobile.php', 'login_required'=>'false'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/mobile/account/setup_password.themes.mobile.css' rel='stylesheet' type='text/css' media='all'/>
...
<section id="rn_PageContent">
    <div class="rn_Padding">
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/login/ResetPassword',
array('label_heading' => '' . \RightNow\Utils\Config::msgGetFrom((1415)) . '','on_success_url' => '' . '/app/account/profile/msg/' . urlencode(getMessage((3848))) . '',));
?>
    </div>
</section>
        </section>
...
( 0 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/EventProvider.js', 1 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Field.js', 2 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Form.js', 3 => 'standard/input/PasswordInput', 4 => 'standard/login/ResetPassword', 5 => 'standard/input/DateInput', 6 => 'standard/input/FormSubmit', 7 => 'standard/input/SelectionInput', 8 => 'standard/input/TextInput', ), '/mobile/account/setup_password.js', '1476968233');?>"></script>
