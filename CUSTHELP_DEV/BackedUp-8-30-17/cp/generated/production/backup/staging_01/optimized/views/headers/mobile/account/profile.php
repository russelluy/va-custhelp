...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((908)) . '', 'template'=>'mobile.php', 'login_required'=>'true'));
...
$result = array( 'js_name' => '', 'library_name' => 'ContactNameInput', 'view_func_name' => '_standard_input_ContactNameInput_view', 'meta' => array ( 'controller_path' => 'standard/input/ContactNameInput', 'view_path' => 'standard/input/ContactNameInput', 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', 1 => '3.3', 2 => '3.4', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4204)', ), 'contains' => array ( 0 => array ( 'widget' => 'standard/input/FormInput', 'versions' => array ( 0 => '1.1', 1 => '1.2', ), ), ), 'relativePath' => 'standard/input/ContactNameInput', 'widget_name' => 'ContactNameInput', ), );
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/mobile/account/profile.themes.mobile.css' rel='stylesheet' type='text/css' media='all'/>
...
<section id="rn_PageContent" class="rn_Profile">
    <div class="rn_Padding">
        <form id="rn_CreateAccount" method="post" action="" onsubmit="return false;">
            <div class="rn_MessageBox rn_InfoMessage rn_Required rn_LargeText"><?=\RightNow\Utils\Url::getParameter('msg');?></div>
            <div id="rn_ErrorLocation"></div>
            <h2><?=\RightNow\Utils\Config::msgGetFrom((4966));?></h2>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput',
array('name' => 'contacts.login','required' => 'true','validate_on_blur' => 'true','initial_focus' => 'true',));
?>
            <a href="/app/account/change_password<?=\RightNow\Utils\Url::sessionParameter();?>"><?=\RightNow\Utils\Config::msgGetFrom((1181));?></a><br/><br/>
            <h2><?=\RightNow\Utils\Config::msgGetFrom((4721));?></h2>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/ContactNameInput',
array('table' => 'contacts','required' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.email','required' => 'true','validate_on_blur' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.street',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.city',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.country_id',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.prov_id',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.postal_code',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.ph_home',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.ph_office',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.ph_mobile',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/CustomAllInput', array('table' => 'contacts','always_show_mask' => 'true',));
?>
            <br/><br/><br/>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4968)) . '','on_success_url' => '/app/utils/submit/profile_updated','error_location' => 'rn_ErrorLocation',));
?>
        </form>
    </div>
</section>
...
( 0 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/EventProvider.js', 1 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Field.js', 2 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Form.js', 3 => 'standard/input/PasswordInput', 4 => 'standard/input/DateInput', 5 => 'standard/input/FormSubmit', 6 => 'standard/input/SelectionInput', 7 => 'standard/input/TextInput', ), '/mobile/account/profile.js', '1476968233');?>"></script>
