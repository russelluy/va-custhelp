...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/askjsp.themes.standard.css' rel='stylesheet' type='text/css' media='all'/>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'Incident.CustomFields.c.city_destination_menu','required' => 'false','label_input' => 'Where are you flying to?',));
?>
...
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/ToggleVisibleArea', array('name' => 'togg','label' => 'Please visit <a href=\'http://www.virginamerica.com/cms/special-assistance/service-animal-travel\' target=\'_blank\'>here</a> for the documentation requirements.','display_value' => 'Incident.CustomFields.c.emotional_support_animal=1964',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/SelectionRadioInput', array('name' => 'Incident.CustomFields.c.oxygen_use','required' => 'false','label_input' => 'Will you be using a respiratory assistive device during the flight?',));
?>
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/input/ToggleVisibleArea', array('name' => 'togg','label' => 'Please download the Medical Oxygen Documentation Form <a href=\'http://virginamerica.custhelp.com/ci/fattach/get/59157/0/filename/Portable+Oxygen+Concentrator+Med+Form.pdf\' target=\'_blank\'>here</a>. Then fill out and attach below.','display_value' => 'Incident.CustomFields.c.oxygen_use=1966',));
?>
...
( 0 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/EventProvider.js', 1 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Field.js', 2 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/Form.js', 3 => 'standard/input/PasswordInput', 4 => 'standard/input/SmartAssistantDialog', 5 => 'custom/input/IncidentTaskInput', 6 => 'custom/input/ProductCategoryInputCustom', 7 => 'standard/input/DateInput', 8 => 'standard/input/FileAttachmentUpload', 9 => 'standard/input/FormSubmit', 10 => 'standard/input/SelectionInput', 11 => 'standard/input/TextInput', 12 => 'custom/input/CustomDateInput', 13 => 'custom/input/CustomFileAttachmentUpload', 14 => 'custom/input/CustomFormSubmit', 15 => 'custom/input/CustomSelectionInput', 16 => 'custom/input/SelectionRadioInput', 17 => 'custom/input/CustomTextInput', 18 => 'custom/input/ToggleVisibleArea', ), '/askjsp.js', '1476968233');?>"></script>
