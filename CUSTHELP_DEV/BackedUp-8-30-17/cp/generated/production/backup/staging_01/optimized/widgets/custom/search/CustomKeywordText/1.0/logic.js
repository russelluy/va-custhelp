/* Originating Release: November 2016 */
RightNow.namespace('Custom.Widgets.search.CustomKeywordText');
Custom.Widgets.search.CustomKeywordText = RightNow.SearchFilter.extend({
    overrides: {
        constructor: function() {
            ...
            if(this._textElement) {
                ...
                if(this.data.attrs.initial_focus == "true"){
