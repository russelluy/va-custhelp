...
get_instance()->_checkMeta(array('javascript_module'=>'mobile_may_10', 'title'=>'' . \RightNow\Utils\Config::msgGetFrom((4872)) . '', 'template'=>'mobile.php', 'login_required'=>'false'));
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/mobile/utils/create_account.themes.mobile.css' rel='stylesheet' type='text/css' media='all'/>
...
array('name' => 'contacts.email','required' => 'true','validate_on_blur' => 'true','initial_focus' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.login','required' => 'true','validate_on_blur' => 'true',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.password_new',));
?>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormInput', array('name' => 'contacts.password_verify',));
?>
...
?>
            <br/><br/>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/input/FormSubmit', array('label_button' => '' . \RightNow\Utils\Config::msgGetFrom((4849)) . '','on_success_url' => '/app/account/questions/list','error_location' => 'rn_ErrorLocation',));
?>
        </form>
    </div>
</section>
