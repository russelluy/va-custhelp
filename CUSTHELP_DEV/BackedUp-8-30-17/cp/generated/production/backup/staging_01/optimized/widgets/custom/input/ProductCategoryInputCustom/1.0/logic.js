...
Custom.Widgets.input.ProductCategoryInputCustom = RightNow.Field.extend({
    overrides: {
        constructor: function() {
            ...
            // NEW CUSTOM EVENT
            RightNowEvent.subscribe("evt_resetSelection", this._resetSelection, this);
