...
get_instance()->_checkMeta(array('title'=>'' . \RightNow\Utils\Config::msgGetFrom((4527)) . '', 'template'=>'standard.php', 'clickstream'=>'answer_list', 'use_profile_defaults'=>'true'));
...
function _standard_knowledgebase_RssIcon_view ($data) {
extract($data);
?><?php ?>
...
function getData() {
if(\RightNow\Utils\Config::getConfig((237))){
return false;
}
$this->data['feedParms'] = '';
if ($p = \RightNow\Utils\Url::getParameter('p')) $this->data['feedParms'] .= "/p/$p";
if ($c = \RightNow\Utils\Url::getParameter('c')) $this->data['feedParms'] .= "/c/$c";
}
}
function _standard_knowledgebase_RssIcon_header() {
$result = array( 'js_name' => '', 'library_name' => 'RssIcon', 'view_func_name' => '_standard_knowledgebase_RssIcon_view', 'meta' => array ( 'controller_path' => 'standard/knowledgebase/RssIcon', 'view_path' => 'standard/knowledgebase/RssIcon', 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/RssIcon.css', 1 => 'assets/themes/standard/widgetCss/RssIcon.css', ), 'version' => '1.1.1', 'requires' => array ( 'framework' => array ( 0 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4190)', 'urlParameters' => array ( 'p' => array ( 'name' => 'rn:msg:(4594)', 'description' => 'rn:msg:(1223)', 'example' => 'p/1,2,3', ), 'c' => array ( 'name' => 'rn:msg:(4574)', 'description' => 'rn:msg:(1247)', 'example' => 'c/1', ), ), ), 'relativePath' => 'standard/knowledgebase/RssIcon', 'widget_name' => 'RssIcon', ), );
$result['meta']['attributes'] = array( 'icon_path' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '', 'type' => 'filepath', 'default' => '', 'inherited' => false, )), 'feed_title' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => \RightNow\Utils\Config::getMessage(3855), 'type' => 'string', 'default' => \RightNow\Utils\Config::getMessage(3855), 'inherited' => false, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
function _standard_knowledgebase_TopicWords_view ($data) {
extract($data);
?><?php ?>
<div id="rn_<?=$this->instanceID;?>" class="<?=$this->classList
?>">
...
for($i = 0;
$i < count($this->data['topicWords']);
$i++) {
if (!(\RightNow\Utils\Url::isExternalUrl($this->data['topicWords'][$i]['url']))) {
$this->data['topicWords'][$i]['url'] .= $this->data['appendedParameters'];
}
}
if(!count($this->data['topicWords'])) $this->classList->add('rn_Hidden');
}
}
function _standard_knowledgebase_TopicWords_header() {
$result = array( 'js_name' => 'RightNow.Widgets.TopicWords', 'library_name' => 'TopicWords', 'view_func_name' => '_standard_knowledgebase_TopicWords_view', 'meta' => array ( 'controller_path' => 'standard/knowledgebase/TopicWords', 'view_path' => 'standard/knowledgebase/TopicWords', 'js_path' => 'standard/knowledgebase/TopicWords', 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/TopicWords.css', 1 => 'assets/themes/standard/widgetCss/TopicWords.css', ), 'js_templates' => array ( 'view' => '<% for (var i = 0; i < topicWordItems.length; i++) { %>  <dt> <% if(!RightNow.Url.isExternalUrl(topicWordItems[i].url)) topicWordItems[i].url += linkString; if(attrs.icon_path) { %> <img alt="" class="rn_FileTypeIcon" src="<%= attrs.icon_path %>"> <% } else if(attrs.display_icon) { %> <%= topicWordItems[i].icon %> <% } %> <a href="<%= topicWordItems[i].url %>" target="<%= attrs.target %>" ><%= topicWordItems[i].title %></a> </dt> <dd> <%= topicWordItems[i].text %> </dd> <% } %>', ), 'template_path' => 'standard/knowledgebase/TopicWords', 'version' => '1.0.2', 'requires' => array ( 'framework' => array ( 0 => '3.0', 1 => '3.1', 2 => '3.2', ), 'jsModule' => array ( 0 => 'standard', 1 => 'mobile', ), ), 'info' => array ( 'description' => 'rn:msg:(4300)', 'urlParameters' => array ( 'kw' => array ( 'name' => 'rn:msg:(13864)', 'description' => 'rn:msg:(2264)', 'example' => 'kw/search', ), ), ), 'relativePath' => 'standard/knowledgebase/TopicWords', 'widget_name' => 'TopicWords', ), );
$result['meta']['attributes'] = array( 'report_id' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => (176), 'type' => 'INT', 'default' => (176), 'min' => 1, 'inherited' => false, )), 'label_title' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => \RightNow\Utils\Config::getMessage(3347), 'type' => 'STRING', 'default' => \RightNow\Utils\Config::getMessage(3347), 'inherited' => false, )), 'display_icon' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => true, 'type' => 'BOOLEAN', 'default' => true, 'inherited' => false, )), 'target' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '_self', 'type' => 'STRING', 'default' => '_self', 'inherited' => false, )), 'add_params_to_url' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => 'kw', 'type' => 'STRING', 'default' => 'kw', 'inherited' => false, )), 'icon_path' => \RightNow\Libraries\Widget\Attribute::__set_state(array( 'value' => '', 'type' => 'STRING', 'default' => '', 'inherited' => false, )), );
return $result;
}
}
namespace RightNow\Widgets{
...
$result = array( 'js_name' => 'RightNow.Widgets.ProductCategorySearchFilter', 'library_name' => 'ProductCategorySearchFilter', 'view_func_name' => '_standard_search_ProductCategorySearchFilter_view', 'meta' => array ( 'controller_path' => 'standard/search/ProductCategorySearchFilter', 'view_path' => 'standard/search/ProductCategorySearchFilter', 'js_path' => 'standard/search/ProductCategorySearchFilter', 'presentation_css' => array ( 0 => 'assets/themes/mobile/widgetCss/ProductCategorySearchFilter.css', 1 => 'assets/themes/standard/widgetCss/ProductCategorySearchFilter.css', ), 'base_css' => array ( 0 => 'standard/search/ProductCategorySearchFilter/base.css', ), 'version' => '1.0.3', 'requires' => array ( 'framework' => array ( 0 => '3.0', 1 => '3.1', 2 => '3.2', ), 'jsModule' => array ( 0 => 'standard', ), 'yui' => array ( 0 => 'panel', 1 => 'gallery-treeview', ), ), 'info' => array ( 'description' => 'rn:msg:(4271)', 'urlParameters' => array ( 'p' => array ( 'name' => 'rn:msg:(4594)', 'description' => 'rn:msg:(1223)', 'example' => 'p/1,2,3', ), 'c' => array ( 'name' => 'rn:msg:(4574)', 'description' => 'rn:msg:(1247)', 'example' => 'c/1', ), ), ), 'relativePath' => 'standard/search/ProductCategorySearchFilter', 'widget_name' => 'ProductCategorySearchFilter', ), );
...
<link href='<?=FileSystem::getOptimizedAssetsDir();?>pages/answers/list.themes.standard.css' rel='stylesheet' type='text/css' media='all'/>
...
<?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/knowledgebase/RssIcon',
array('icon_path' => '',));
?>
...
?>
                ...
                <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/SearchButton', array('report_id' => '176',));
?>
            </form>
            <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/DisplaySearchFilters', array('report_id' => '176',));
?>
        </div>
    <?endif;?>
</div>
...
?>
        <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/knowledgebase/TopicWords', array());
?>
