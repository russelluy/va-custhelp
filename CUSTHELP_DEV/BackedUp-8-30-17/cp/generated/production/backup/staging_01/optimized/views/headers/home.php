...
.rn_CustomKeywordText input{font-size:1.333em;}
.rn_CustomKeywordText{display:inline;}
.rn_CustomKeywordText label{display:none;}
...
array('label_button' => 'Make a Call','icon_alt_text' => 'Make a Call','is_link' => 'false','target' => 'myCallDiv',));
?>
    ...
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/display/CustomInfoButton', array('label_button' => 'Send an E-Mail','icon_alt_text' => 'Send an E-Mail','is_link' => 'false','target' => 'myEmailDiv',));
?>
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/display/CustomInfoButton', array('label_button' => 'Post a Twitter','icon_alt_text' => 'Post a Twitter','is_link' => 'true','target' => 'https://www.twitter.com/VirginAmerica',));
?>
    <!------------------------------------By Niven 12/07/2015-------------------------------------->
    ...
    <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/display/CustomInfoButton', array('label_button' => 'Use the Online Chat','icon_alt_text' => 'Use the Online Chat','is_link' => 'true','target' => 'http://virginamericareservations.custhelp.com/app/chat/chat_invite',));
?>
    <!-- ----------------------------------------------------------------------------------------- -->
  </div>
</div>
...
<div style="float: left;width: 60%;">
  <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('standard/search/ProductCategoryList', array('report_page_url' => '/app/home','label_title' => 'Frequently Asked Questions','data_type' => 'categories','levels' => '1',));
?>
...
?>
        <div class="rn_SearchInput">
          <?=\RightNow\Utils\Widgets::rnWidgetRenderCall('custom/search/CustomKeywordText', array('label_text' => '' . \RightNow\Utils\Config::msgGetFrom((1962)) . '','placeholder' => 'Search answers for...','initial_focus' => 'false',));
?>
        </div>
...
( 0 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/EventProvider.js', 1 => '/euf/core/3.2.6/js/4.122/min/widgetHelpers/SearchFilter.js', 2 => 'custom/display/CustomInfoButton', 3 => 'custom/search/CustomKeywordText', 4 => 'standard/search/SearchButton', 5 => 'standard/search/AdvancedSearchDialog', 6 => 'standard/reports/Multiline', 7 => 'custom/util/CustomInfoButton', 8 => 'standard/search/KeywordText', 9 => 'standard/search/SearchTypeList', 10 => 'standard/search/WebSearchSort', 11 => 'standard/search/WebSearchType', 12 => 'standard/search/ProductCategorySearchFilter', 13 => 'standard/search/FilterDropdown', 14 => 'standard/search/SortList', ), '/home.js', '1476968233');?>"></script>
