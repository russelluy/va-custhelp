...
<rn:widget path="chat/ChatAgentCustomAvail" />
  ...
  <rn:condition url_parameter_check="incidents.c$typeofquestion==1858" ||rn:condition url_parameter_check="incidents.c$typeofquestion==1866">
...
-->
      <rn:condition url_parameter_check="incidents.c$typeofquestion==1857">
        ...
        <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.elevatesubject" required="true" label_input="Elevate Help Request" always_show="true" radio="true" />
    ...
    -->
        <rn:widget path="custom/input/ToggleVisibleArea" name="togg" label="<a target='_blank' href='http://www.virginamerica.com/cms/elevate-frequent-flyer/partners/airline-partners'>For more info click here</a>" display_value="Incident.CustomFields.c.elevatesubject=1869" />
        <br>
       ...
       Other id=1872 
    -->
        <rn:widget path="custom/input/CustomTextInput" name="Incident.CustomFields.c.altelevatenum1" required="false" always_show="false" label_input="Additional Elevate Number (11 digit number)" display_value="Incident.CustomFields.c.elevatesubject=1872,Incident.CustomFields.c.elevatesubject=1868" />
        <rn:widget path="input/FormInput" name="incidents.subject" required="true" label_input="Subject"/>
        <rn:widget path="input/FormInput" name="incidents.thread" required="true" label_input="Let us know how we can help you?"/>
      </rn:condition>
      <!--
...
-->
      <rn:condition url_parameter_check="incidents.c$typeofquestion==1858">
        ...
        <rn:widget path="input/FormInput" name="contacts.first_name" required="true" initial_focus="false" label_input="First Name"/>
        <rn:widget path="input/FormInput" name="contacts.last_name" required="true" label_input="Last Name"/>
        <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.concern_or_kudos" always_show="true" radio="true" lbl="Comment Type" label_input="Comment Type" />
        <br/>
        <rn:widget path="input/FormInput" name="Incident.CustomFields.c.contactprimaryelevate" required="false" label_input="Elevate Number (If you have it handy - 11 digit number)" />
        <rn:widget path="input/FormInput" name="Incident.CustomFields.c.confirmationcode" label_input="Virgin America Booking Confirmation Code" required="false" />
        <rn:widget path="input/FormInput" name="contacts.email" required="true" label_input="#rn:msg:EMAIL_ADDR_LBL#" />
        ...
        <rn:widget path="custom/input/CustomFileAttachmentUploadNew" display_thumbnail="true" label_input="Have something to show us? Attach it here." />
      </rn:condition>
      <!--
...
-->
      <rn:condition url_parameter_check="incidents.c$typeofquestion==1860">
        ...
        <rn:widget path="input/FormInput" name="contacts.first_name" required="true" initial_focus="false" label_input="First Name"/>
        <rn:widget path="input/FormInput" name="contacts.last_name" required="true" label_input="Last Name"/>
        <rn:widget path="input/FormInput" name="Incident.CustomFields.c.contactprimaryelevate" label_input="Elevate Number (If you have it handy - 11 digit number)" required="false"/>
        <rn:widget path="input/FormInput" name="Incident.CustomFields.c.confirmationcode" label_input="Virgin America Booking Confirmation Code" required="false" />
        <rn:widget path="input/FormInput" name="contacts.email" required="true" label_input="#rn:msg:EMAIL_ADDR_LBL#" />
        <rn:widget path="input/FormInput" name="Incident.CustomFields.c.contactphone" required="false" label_input="Phone Number" />
        <rn:widget path="input/FormInput" name="incidents.subject" required="true" label_input="Subject"/>
...
-->
      <rn:condition url_parameter_check="incidents.c$typeofquestion==1866">
        ...
        <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.receipt_type" always_show="true" radio="true" lbl="Type of Receipt"/>
        <br/>
...
-->   
      <rn:condition url_parameter_check="incidents.c$typeofquestion==1868">
        ...
        <div style="display:none">
          <rn:widget path="input/SelectionInput" name="incidents.c$cabinofservice" required="false" />
        </div>
...
-->
      <rn:condition url_parameter_check="incidents.c$typeofquestion==2079">
        <style>
        ...
        <rn:widget path="custom/input/ToggleVisibleArea" name="togg" label="<p>Please visit <a href='http://virginamerica.custhelp.com/app/answers/detail/a_id/91' target='_blank'>here</a> for the documentation requirements.</p>" display_value="Incident.CustomFields.c.emotional_support_animal=2069" />
        ...
        <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.oxygen_use" required="false" label_input="Will you be using a Respiratory Assistive Device during the flight, such as for example, a portable oxygen concentrator, CPAP, respirator or ventilator?" />
        ...
        <rn:widget path="custom/input/CustomFileAttachmentUpload" required="false" label_input="Upload Form" display_value="Incident.CustomFields.c.oxygen_use=2071" />
        ...
        <rn:widget path="custom/input/SelectionRadioInput" name="Incident.CustomFields.c.special_assist_other" required="false" label_input="Do you require assistance not listed above such as a seating accommodation, stowage of assistive devices, or escort assistance?" />
        <div class="rn_Hidden">
          <rn:widget path="input/FormInput" name="incidents.subject" required="true" label_input="Subject" default_value="Special Request" />
        </div>
        <rn:widget path="custom/input/CustomTextInput" name="incidents.thread" always_show="true" required="true" label_input="Let us know how we can help you?" display_value="Incident.CustomFields.c.special_assist_other=2073"/>
      </rn:condition>
      <div class="rn_Hidden">
        <rn:widget path="input/SelectionInput" name="incidents.c$typeofquestion" default_value="1846" required="false" />
      </div>
      <rn:widget path="custom/input/CustomSmartAssist" label_dialog_title="Possible Answers - Smart Assistant" label_prompt="The following answers might help you immediately. Click the arrow to expand the answer."/>
      <rn:condition url_parameter_check="incidents.c$typeofquestion!=1866">
        <rn:widget path="custom/input/CustomFormSubmit" label_button="Fill the form to proceed" on_success_url="/app/ask_confirm" always_show="true" display_value="submit" error_location="rn_ErrorLocation" />
      </rn:condition>
    </form>
  </div>
</div>
