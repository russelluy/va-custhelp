...
switch(getUrlParm('error_id'))
{
    ...
    case 'sso10':
        ...
        break;
    case 'sso11':
        $errorTitle = getMessage(DUPLICATE_EMAIL_LBL);
        $errorMessage = sprintf(getMessage(SORRY_EMAIL_ADDR_EXS_COMMUNITY_MSG), '<a href="/app/utils/account_assistance' . sessionParm() . '">', '</a>');
        break;
    case 'sso13':
    case 'sso14':
    case 'sso15':
    ...
    case 404:
        ...
        $errorMessage = sprintf(getMessage(PAGE_YOU_REQUESTED_WAS_NOT_FOUND_MSG));
        break;
    default:
