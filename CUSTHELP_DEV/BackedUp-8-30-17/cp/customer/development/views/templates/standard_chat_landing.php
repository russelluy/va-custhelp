...
<head class="no-js">
    ...
    <meta http-equiv="Content-Language" content="#rn:language_code#">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta name="apple-mobile-web-app-capable" content="yes">
    <title>#rn:msg:LIVE_ASSISTANCE_LBL# | Virgin America</title>
                    ...
                    <nav class="footer-nav cf ng-scope" ng-switch-when="large">
                        <ul class="footer-nav__list">
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/sitemap" target="_self">Sitemap</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="http://virginamerica.custhelp.com/">Contact Us/FAQs</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/contract-of-carriage" target="_self">Contract of Carriage</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/intl-contract-of-carriage" target="_self">Int’l Contract of Carriage</a>
                            </li>
                        </ul>
                        <ul class="footer-nav__list">
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/blog" target="_self">Blog</a></li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/about-our-airline" target="_self">About Us</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/about-our-airline/press" target="_self">Press &amp; Awards</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/news" target="_self">All News &amp; Updates</a>
                            </li>
                        </ul>
                        <ul class="footer-nav__list">
                             <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/legal/guest-service-commitment" target="_self">Guest Services Commitment</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/accessibility-services" target="_self">Accessibility Services</a>
                            </li>
                            <li class="footer-nav__item">
                            ...
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/fly-with-us/Mobile-App" target="_self">Mobile App</a>
                            </li>
                        </ul>
                        <ul class="footer-nav__list">
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/corporate-travel" target="_self">Corporate &amp; Group Travel</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/corporate-travel/travel-agents" target="_self">Travel Agency</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/travel-guard" target="_self">Travel Insurance</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/airline-jobs" target="_self">Careers</a>
                            </li>
                        </ul>
                        <ul class="footer-nav__list">
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/elevate-frequent-flyer" target="_self">What Is Elevate?</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://creditcard.virginamerica.com" target="_self">Virgin America Credit Card</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/advertise-onboard" target="_self">Advertise Onboard</a>
                            </li>
                            <li class="footer-nav__item">
                        ...
                        <ul class="footer-nav__list">
                            ...
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/corporate-responsibility" target="_self">Corporate Responsibility</a>
                            </li>
                            <li class="footer-nav__item">
                                <a href="https://virginamerica.com/cms/legal/privacy-policy" target="_self">Privacy Policy</a>
                            </li>
                        </ul>
                        <ul class="footer-nav__list footer__social-icon" style="width: 100%">
                            <li class="social-icon icon-facebook">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Facebook" target_url="https://www.facebook.com/VirginAmerica" target="leavingSiteModal" />
                            </li>
                            <li class="social-icon icon-twitter">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Twitter" target_url="https://twitter.com/VirginAmerica" target="leavingSiteModal" />
                            </li>
                            <li class="social-icon icon-youtube">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Youtube" target_url="https://www.youtube.com/user/VirginAmerica" target="leavingSiteModal" />                                    
                            </li>
                            <li class="social-icon icon-instagram">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Instagram" target_url="https://www.instagram.com/virginamerica/" target="leavingSiteModal" />
                            </li>
                            <li class="social-icon icon-google-plus">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Google Plus" target_url="https://plus.google.com/+VirginAmerica/" target="leavingSiteModal" />
                            </li>
                            <li class="social-icon icon-snapchat">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="Snapchat" target_url="https://www.snapchat.com/add/virginamerica" target="leavingSiteModal" />
                            </li>
                            <li class="social-icon icon-linkedin">
                                <rn:widget path="custom/util/ExternalLinkModal" link_label="LinkedIn" target_url="https://www.linkedin.com/company/virgin-america" target="leavingSiteModal" />
                            </li>
