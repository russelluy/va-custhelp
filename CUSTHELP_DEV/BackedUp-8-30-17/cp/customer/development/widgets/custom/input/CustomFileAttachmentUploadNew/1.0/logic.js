RightNow.namespace('Custom.Widgets.input.CustomFileAttachmentUploadNew');
Custom.Widgets.input.CustomFileAttachmentUploadNew = RightNow.Field.extend({ 
    overrides: {
    ...
    */
    ...
    _sendUploadRequest: function() {
        ...
        if (RightNow.Event.fire("evt_fileUploadRequest", this._eo)) {
            ...
            RightNow.Ajax.makeRequest("/ci/fattach/upload", null, {
                json: true,
                data: this._eo,
                scope: this,
    ...
    _renderNewAttachmentItem: function(filename, count) {
        ...
        if (!this._attachmentList) {
            ...
            this._statusMessage.insert(this._attachmentList, "before");
        }
