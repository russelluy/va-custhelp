...
Search = (function() {
    ...
    function _searchReportViaAjax(searchFilters, searchSource, triggerObjectFilters) {
        ...
        if (cachedSearch) {
            History.restoreCache(requestObject);
            SourceConductor.get(cacheKey).fire("response", new RightNow.Event.EventObject(null, {data: cachedSearch, filters: searchFilters}));
            return;
        }
            ...
            overrides: {
                constructor: function(Y, instanceID) {
                    ...
                    .on("reset", function() {
                        ...
                        var filters = (this._filters) ? this._filters.allFilters : null;
