        ...
        <? else: ?>
            <? if($this->data['js']['catSubscriptionID'] !== null): ?>
                <div id="rn_<?= $this->instanceID ?>_CatSubscribed" class="<?= ($this->data['subscriptionID'] === null) ? "rn_SpillOverText" : "rn_Hidden" ?> rn_Unsubscribe">
                    <a href="/app/<?= \RightNow\Utils\Config::getConfig(CP_PRODUCTS_DETAIL_URL) ?>/c/<?= $this->data['categoryID'] ?>#rn:session#" title="<?= $this->data['attrs']['label_subscribed_to_product_category_title'] ?>">
                        <span>
