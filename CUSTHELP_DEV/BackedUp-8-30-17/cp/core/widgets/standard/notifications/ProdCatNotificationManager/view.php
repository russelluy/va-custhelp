    ...
    <form id="rn_<?= $this->instanceID ?>_Form">
        <div id="rn_<?=$this->instanceID;?>_Dialog" class="rn_ProdCatNotificationManager_Dialog rn_Hidden">
            <div class="rn_SelectionWidget">
                <rn:widget path="input/ProductCategoryInput" label_set_button="#rn:msg:ADD_PRODUCT_CMD#" set_button="true" linking_off="true" sub_id="prod"/>
            </div>
            <div class="rn_SelectionWidget">
                <rn:widget path="input/ProductCategoryInput" data_type="Category" label_input="#rn:msg:CATEGORY_LBL#" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#" label_set_button="#rn:msg:ADD_CATEGORY_CMD#" set_button="true" linking_off="true" sub_id="cat"/>
            </div>
        </div>
    </form>
    <rn:block id="bottom"/>
