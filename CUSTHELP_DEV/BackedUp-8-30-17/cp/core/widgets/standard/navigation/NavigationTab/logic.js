    ...
    */
    _openDropdown: function() {
        if(!this._dropdownOpen) {
            this._tabRegion = this._tabElement.get('region');
            var left = (this._tabElement.hasClass(this.data.attrs.css_class) ? 4 : 0);
            this._dropdownElement
                .setStyle("top", (this._tabRegion.bottom - 4) + "px")
                .setStyle("left", (this._tabRegion.left - left) + "px")
