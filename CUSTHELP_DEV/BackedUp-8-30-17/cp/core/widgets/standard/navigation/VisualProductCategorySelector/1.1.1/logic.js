...
RightNow.Widgets.VisualProductCategorySelector = RightNow.Widgets.extend({
    ...
    _paginateItems: function(container, options) {
        ...
        if(options.direction) {
            (options.direction === 'forward') ? pageNumber++ : pageNumber--;
        }
    ...
    _displayInitialItemSet: function(items) {
        ...
        this.showNewGroup(items, { id: id, level: ++level, focusOnFirst: this.data.attrs.initial_focus, isInitialLoad: true });
    },
