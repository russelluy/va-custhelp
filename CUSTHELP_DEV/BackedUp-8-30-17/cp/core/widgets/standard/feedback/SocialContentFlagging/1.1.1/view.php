...
<div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?>">
    <rn:block id="top"/>
    <a href="javascript:void(0);" role="button" id="rn_<?= $this->instanceID ?>_Button" class="rn_CommentAction rn_FlagAction" aria-haspopup="<?= count($this->data['js']['flags']) > 1 ? 'true' : 'false' ?>" title="<?= $this->helper->getFlagTitle() ?>">
