        ...
        <div class="rn_BestAnswerBody rn_CommentCollapsed">
            ...
            <div class="rn_BestAnswerActions">
                ...
                <div class="rn_BestAnswerCommentActions">
                    <a itemprop="url" class="rn_ReplyToComment <?= $this->data['attrs']['always_show_jump_to'] ? '' : 'rn_Hidden' ?>" role="button" href="javascript:void(0)" data-commentid="<?= $bestAnswer['comment']['data']->ID ?>">
