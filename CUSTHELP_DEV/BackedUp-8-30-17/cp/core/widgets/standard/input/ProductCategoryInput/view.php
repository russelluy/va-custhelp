...
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
    ...
    <span class="rn_Label" id="rn_<?= $this->instanceID ?>_Label">
        ...
        <span class="rn_Required"> <?=\RightNow\Utils\Config::getMessage(FIELD_REQUIRED_MARK_LBL);?></span><span id="rn_<?=$this->instanceID;?>_RequiredLabel" class="rn_RequiredLabel">
