...
<div id="rn_<?=$this->instanceID;?>" class="<?=$this->classList;?>">
    <div id="rn_<?=$this->instanceID;?>_Content" class="rn_Content">
        ...
        <div id="rn_<?=$this->instanceID;?>_Title" class="rn_FacetsTitle"><?=$this->data['attrs']['label_filter'];?>
            <span class="rn_ClearContainer">[<a class="rn_ClearFacets" href="javascript:void(0)"><?=$this->data['attrs']['label_clear'];?><span class="rn_ScreenReaderOnly"><?= $this->data['attrs']['label_clear_screenreader'] ?></span></a>]</span>
        </div>
