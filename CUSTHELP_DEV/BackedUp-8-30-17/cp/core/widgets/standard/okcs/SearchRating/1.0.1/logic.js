...
RightNow.Widgets.SearchRating = RightNow.SearchConsumer.extend({
    overrides: {
        constructor: function() {
            ...
            if (this._searchRatingHeader) {
                this._searchRatingHeader.delegate('click', this._onHeaderClick, '#rn_SearchRatingHeader', this);
            }
    ...
    */
    _onRatingClick: function(evt) {
        ...
        this._updateAriaAlert(this.data.attrs.label_rating_message_screenreader);
                ...
                if(searchResult.data.searchResults.results !== null && searchResult.data.searchResults.results.results.length <= 0) {
                    ...
                    if(this.data.attrs.toggle_title) {
                        if (this._searchRatingHeader !== null) {
                            ...
                            var headerNode = this.Y.Node.create("<h2 id=\"rn_SearchRatingHeader\">" + this.data.attrs.search_rating + "</h2>");
