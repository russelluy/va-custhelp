...
RightNow.Widgets.ModerationInlineAction = RightNow.Widgets.extend({
    ...
    _onModeratorActionSubmitSuccess: function (response) {
        ...
        if (response.updatedObject.ID) {
            RightNow.UI.displayBanner(response.updatedObject.successMessage, { focus: true });
            ...
            RightNow.UI.displayBanner(response.error || this.data.attrs.label_on_failure_banner, {focus: true, type: 'ERROR'});
       }
    },
