...
final class ValidateCPHistory extends \RightNow\Controllers\Admin\Base {
    ...
    public function index() {
        $dirs = array(
            ...
            array("15.5",  "core/",                          "framework/manifest", "version", "widgets/"),
        );
        ...
        $this->compareCPHistories($aggregateCPHistory, @yaml_parse_file("{$this->documentRoot}/core/cpHistory"));
                ...
                for ($i = 1; $i < count($widgetVersions); $i++) {
                    ...
                    if ($widgetVersionsInfo[$widgetVersions[$i]]['cxRelease'] === $nextRelease) {
                        ...
                        if ($previousWidgetMajorMinorVersion !== $nextWidgetMajorMinorVersion) {
                            ...
                            if (in_array($nextMajorMinor, $previousWidgetInfo['requires']['framework']))
     ...
     * @param array $haystack String to look in
     * @param array $needle String to find
     */
