...
<section id="rn_PageContent" class="rn_LoginForm">
    <div id="rn_ThirdPartyLogin" class="rn_Padding">
        ...
        <rn:widget path="login/OpenLogin" controller_endpoint="/ci/openlogin/openid/authorize" label_service_button="Wordpress" openid="true" preset_openid_url="https://[username].wordpress.com" openid_placeholder="[#rn:msg:YOUR_WORDPRESS_USERNAME_LBL#]" label_process_explanation="#rn:msg:YOULL_LOG_ACCT_WORDPRESS_WINDOW_MSG#" label_login_button="#rn:msg:LOG_IN_USING_WORDPRESS_LBL#"/>
